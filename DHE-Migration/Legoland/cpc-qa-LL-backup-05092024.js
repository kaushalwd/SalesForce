...
%%[
   ...
   /*output(concat("married: ",@married))*/
    ...
    Other_Please_specify__c,Reason_of_Unsubscribe__c,Email__c,WhatsApp__c",
          ...
          <div class="container">
              <div class="row align-items-center" style="margin: 0 auto;">
                  ...
                  <a href="https://dubaiholding.com/en/who-we-are/our-companies/dubai-holding-entertainment/" class="logo-link" target="_blank">
                      <img src="https://image.explore.legoland.ae/lib/fe30117373640479741375/m/1/e6bdbf12-e6d8-47ac-ac13-820c01298586.png"
...
IF (empty(@crmId)) THEN
    ...
    ENDIF   
          ...
          %%[
                                IF RequestParameter("submittedProfile")==true then
                                  ...
                                  /* Redirect(Concat("https://cloud.explore.legoland.ae/LL_CPC_QA?sfid=", Base64Encode(@sfid), "#interests")) */
                                   ...
                                   if @methodType== 'Old' then
                                      Redirect(Concat("https://cloud.explore.legoland.ae/LLQA_CPC?sfid=", Base64Encode(@sfid), "#interests"))
                                   ELSE
        ...
        /*Redirect(Concat("https://cloud.explore.dubaiholdingentertainment.com/roxyqa_cpc", "#communications"))*/
         /*Redirect(Concat("https://cloud.explore.legoland.ae/LL_CPC_QA?sfid=", Base64Encode(@sfid), "#communications"))*/
    ...
    set @communications = '#communications'
                                   ...
                                   if @methodType== 'Old' then
                                      Redirect(Concat("https://cloud.explore.legoland.ae/LLQA_CPC?sfid=", Base64Encode(@sfid), "#communications"))
                                   ELSE
        ...
        <div class="tab-pane fade preferences-tab-content" id="communications" role="tabpanel" aria-labelledby="communications-tab">
          <div class="wrapper wrapper--w700">
            ...
            %%[
                                ...
                                /*Redirect("https://cloud.explore.dubaiholdingentertainment.com/thankyou_roxy_qa?sfid=0036M00004SEQwKQAX")*/
                                /*Redirect(Concat("https://cloud.explore.legoland.ae/LL_ThankYou_QA?sfid=", Base64Encode(@sfid), "#ThankYou"))*/
                               ...
                               if @methodType== 'Old' then
                                      Redirect(Concat("https://cloud.explore.legoland.ae/ThankYou_LL_QA?sfid=", Base64Encode(@sfid), "#ThankYou"))
                               ELSE
        ...
        <div class="container">
            <div class="unsubscribe-wrapper form group">
                ...
                <div class="thankYou-text">
                    ...
                    <p style="font-size:16px; line-height:18px; color:#000000; font-weight: bold; padding-bottom:3rem;">Your channel subscription preferences have been successfully updated. </p>  
                </div>
             ...
             <input name="guestId" type="hidden" value="%%=v(@Id)=%%"><br> 
                   ...
                   %%[
                                ...
                                ENDIF
                                  ...
                                  /* Redirect(Concat("https://cloud.explore.legoland.ae/ThankYou_LL?sfid=", Base64Encode(@sfid), "#ThankYou"))*/
...
<!-- footer start -->
  <footer>
      ...
      <!-- footer End -->                     
    <!-- Vendor JS-->
     <script src="https://cloud.explore.legoland.ae/LL_bootstrap_QA.min.js"></script>
    <script src="https://cloud.explore.legoland.ae/LL_select2_QA.min.js"></script>
    <script src="https://cloud.explore.legoland.ae/LL_moment_QA.min.js"></script>
  

    <!-- Main JS-->
    <script src="https://cloud.explore.legoland.ae/LL_custom_QA.js"></script>
...
$(document).on("click", ".del", function() {
  ...
  console.log('deleted 2');
                ...
                $.ajax({
                    url: 'https://cloud.explore.legoland.ae/LL_KidsDelete_QA', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
    ...
    /* if( emailPref.checked !='undefined'){
        ...
        console.log('whatsAppPref: ',whatsAppPref);
                ...
                $.ajax({
                    url: 'https://cloud.explore.legoland.ae/LL_QA_ChannelPreference', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
      ...
      $("#unsubscribeClick").click(function(e) {
        ...
        var subsKey = document.getElementById('crmId').value;
                ...
                $.ajax({
                    url: 'https://cloud.explore.legoland.ae/LL_UnsubscribeFromBU_QA', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
                        console.log('SFMC Code Resource called successfully.');
      ...
      $("#unsubscribeAllClick").click(function(e) {
        ...
        var guestId = document.getElementById('guestId').value;
                ...
                $.ajax({
                    url: 'https://cloud.explore.legoland.ae/LL_UnsubscribeFromAllBU_QA', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
                        console.log('SFMC Code Resource called successfully.');
