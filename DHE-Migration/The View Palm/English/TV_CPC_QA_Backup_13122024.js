...
%%[
    ...
    IF @guestDetailsRowCount > 0 THEN /*Roxy*/
        ...
        set @factorInfluencingVisit = Field(@guestDetailsRow, "Factor_influencing_decision_to_visit_TV__c")
        ...
        set @newExperiences= Field(@guestDetailsRow, "New_experiences_and_entertainment__c")
...
<script runat="server">
  Platform.Load("core", "1.1.2");
        ...
        var listExperiences = Platform.Request.GetFormField('hearExperiences') || false;
        var listFoodAndRestaurants = Platform.Request.GetFormField('newFoodAndRestaurants') || false;
  ...
  listOfInput.push({Name : 'The View - Upcoming events for families', Status: listEvents })
  listOfInput.push({Name : 'The View - New experiences and entertainment', Status: listExperiences})
        listOfInput.push({Name : 'The View - New food and restaurants', Status: listFoodAndRestaurants})
...
<!DOCTYPE html>
 ...
 <link rel="icon" type="image/x-icon" href="https://image.explore.theviewpalm.ae/lib/fe3111737364047a741c70/m/1/81c38d8b-db8a-4a2d-827c-c7e5120fb046.png">
                                <link href='https://cloud.explore.theviewpalm.ae/TV_QA_bootstrap.min.css' rel='stylesheet'>
                                
                                <script type='text/javascript' src='https://cloud.explore.theviewpalm.ae/TV_QA_jquery.min.js'></script>
                             
                                <!-- Font special for pages-->
                                <link href="https://fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
                                <link href="https://cloud.explore.theviewpalm.ae/TV_QA_style.css" rel="stylesheet">
                                
                              
                               
                                <!-- Vendor CSS-->
                                <link href="https://cloud.explore.theviewpalm.ae/TV_QA_select2.min.css" rel="stylesheet" media="all">
...
<script runat=server>
  ...
  Platform.Response.SetResponseHeader("Content-Security-Policy","script-src 'self' 'unsafe-inline' https://image.explore.thegreenplanetdubai.com https://cloud.explore.globalvillage.ae; frame-ancestors 'none'");
        ...
        <header>
          <div class="container">
              <div class="row align-items-center" style="margin: 0 auto;">
                  ...
                  <a href="https://dubaiholding.com/en/" class="logo-link" target="_blank">
                      <img src="https://image.explore.thegreenplanetdubai.com/lib/fe3b117373640479751472/m/1/10fda4f3-7cb5-41da-a173-7e6799dcfc22.png"
           ...
           <div class="lang-switcher-text">
            <a href="https://cloud.explore.theviewpalm.ae/TV_CPC_Arabic_QA" class="language-toggle-link"  id="langSwitcher" onclick="dynamicLangSwitcher();"  style="text-decoration: underline;">العربية</a>
          </div>
      ...
      <!-- content -->
      <div class="tab-content" id="pills-tabContent p-3" style="padding-right: 20px; padding-left: 20px;">
        <!-- 1st card -->
...
<option value="British Indian Ocean Territory" %%=IIF(@country=='British Indian Ocean Territory', "selected", "")=%%>British Indian Ocean Territory</option>
...
<option value="Central African Republic" %%=IIF(@country=='Central African Republic', "selected", "")=%% >Central African Republic</option>
<option value="Ceuta & Melilla" %%=IIF(@country=='Ceuta & Melilla', "selected", "")=%% >Ceuta & Melilla</option>
...
<option value="Cote d'Ivoire" %%=IIF(@country=='Cote d'Ivoire', "selected", "")=%% >Cote d'Ivoire</option>
...
<option value="Democratic Republic of the Congo" %%=IIF(@country=='Democratic Republic of the Congo', "selected", "")=%% >Democratic Republic of the Congo</option>
...
<option value="French Southern Territories" %%=IIF(@country=='French Southern Territories', "selected", "")=%% >French Southern Territories</option>
...
<option value="Heard Island and McDonald Islands" %%=IIF(@country=='Heard Island and McDonald Islands', "selected", "")=%% >Heard Island and McDonald Islands</option>
...
<option value="Northern Mariana Islands" %%=IIF(@country=='Northern Mariana Islands', "selected", "")=%%>Northern Mariana Islands</option>
...
<option value="Republic of Korea" %%=IIF(@country=='Republic of Korea', "selected", "")=%%>Republic of Korea</option>
...
<option value="Saint Martin (French part)" %%=IIF(@country=='Saint Martin (French part)', "selected", "")=%%>Saint Martin (French part)</option>
<option value="Saint Pierre and Miquelon" %%=IIF(@country=='Saint Pierre and Miquelon', "selected", "")=%%>Saint Pierre and Miquelon</option>
<option value="Saint Vincent And The Grenadines" %%=IIF(@country=='Saint Vincent And The Grenadines', "selected", "")=%%>Saint Vincent And The Grenadines</option>
...
<option value="Sint Maarten" %%=IIF(@country=='Sint Maarten', "selected", "")=%%>Sint Maarten</option>
...
<option value="Turks and Caicos Islands" %%=IIF(@country=='Turks and Caicos Islands', "selected", "")=%%>Turks and Caicos Islands</option>
...
<option value="United States Minor Outlying Islands" %%=IIF(@country=='United States Minor Outlying Islands', "selected", "")=%%>United States Minor Outlying Islands</option>
...
<option value="Wallis and Futuna" %%=IIF(@country=='Wallis and Futuna', "selected", "")=%%>Wallis and Futuna</option>
...
<option value="Others" %%=IIF(@country=='Others', "selected", "")=%%>Others</option>
...
<option value="British Indian Ocean Territory" %%=IIF(@nationality=="British Indian Ocean Territory", "selected", "")=%%>British Indian Ocean Territory</option>
...
<option value="Central African Republic" %%=IIF(@nationality=="Central African Republic", "selected", "")=%% >Central African Republic</option>
<option value="Ceuta & Melilla" %%=IIF(@nationality=="Ceuta & Melilla", "selected", "")=%% >Ceuta & Melilla</option>
...
<option value="Cote d'Ivoire" %%=IIF(@nationality=="Cote d'Ivoire", "selected", "")=%% >Cote d'Ivoire</option>
...
<option value="Democratic Republic of the Congo" %%=IIF(@nationality=="Democratic Republic of the Congo", "selected", "")=%% >Democratic Republic of the Congo</option>
...
<option value="French Southern Territories" %%=IIF(@nationality=="French Southern Territories", "selected", "")=%% >French Southern Territories</option>
...
<option value="Heard Island and McDonald Islands" %%=IIF(@nationality=="Heard Island and McDonald Islands", "selected", "")=%% >Heard Island and McDonald Islands</option>
...
<option value="Northern Mariana Islands" %%=IIF(@nationality=="Northern Mariana Islands", "selected", "")=%%>Northern Mariana Islands</option>
...
<option value="Republic of Korea" %%=IIF(@nationality=="Republic of Korea", "selected", "")=%%>Republic of Korea</option>
...
<option value="Saint Martin (French part)" %%=IIF(@nationality=="Saint Martin (French part)", "selected", "")=%%>Saint Martin (French part)</option>
<option value="Saint Pierre and Miquelon" %%=IIF(@nationality=="Saint Pierre and Miquelon", "selected", "")=%%>Saint Pierre and Miquelon</option>
<option value="Saint Vincent And The Grenadines" %%=IIF(@nationality=="Saint Vincent And The Grenadines", "selected", "")=%%>Saint Vincent And The Grenadines</option>
...
<option value="Sint Maarten" %%=IIF(@nationality=="Sint Maarten", "selected", "")=%%>Sint Maarten</option>
...
<option value="Turks and Caicos Islands" %%=IIF(@nationality=="Turks and Caicos Islands", "selected", "")=%%>Turks and Caicos Islands</option>
...
<option value="United States Minor Outlying Islands" %%=IIF(@nationality=="United States Minor Outlying Islands", "selected", "")=%%>United States Minor Outlying Islands</option>
...
<option value="Wallis and Futuna" %%=IIF(@nationality=="Wallis and Futuna", "selected", "")=%%>Wallis and Futuna</option>
...
<option value="Others" %%=IIF(@nationality=="Others", "selected", "")=%%>Others</option>
              ...
              %%[
                                IF RequestParameter("submittedProfile")==true then
                                   ...
                                   if @methodType== 'Old' then
                                      Redirect(Concat("https://cloud.explore.insideburjalarab.com/TV_CPC_QA?sfid=", Base64Encode(@sfid), "#interests"))
                                   ELSE
                                      Redirect(CONCAT(CloudPagesURL(3624),@interests))
                                   ENDIF
...
%%[
                                   ...
                                   set @factorInfluencingString = BuildRowsetFromString(@factorInfluencingVisit,";")
                                   set @factorInfluencingCount = rowCount(@factorInfluencingString)
                                   
                                   if @factorInfluencingCount > 0 then
                                      for @i = 1 to @factorInfluencingCount do
                                           
                                           SET @val = Field(Row(@factorInfluencingString,@i),1)
                                           
                                           IF @val == "Recommendations from others" THEN
                                           SET @recommendations = "checked"
                                           ELSEIF @val == "Online reviews" THEN
                                           SET @onlineReviews = "checked"
                                           ELSEIF @val == "Promotional offers and discounts" THEN
                                           SET @promotionalOffers = "checked"
                                           ELSEIF @val == "Exclusive events or activities" THEN
                                           SET @exclusiveEvents = "checked"
        ...
        <div class="tab-pane fade interest-tab-content" id="interests" role="tabpanel" aria-labelledby="interests-tab">
            ...
            <div class="wrapper wrapper--w700">
              ...
              <form class="interest-form" action="" method="post" name="myForm" id="interest-form" autocomplete="off" >
                  ...
                  <div class="form-group">
                    <h4 class="pt-4 pb-3">What is the main factor influencing your decision to visit The View Palm Jumeirah?</h4>
                    <div class="radio-wrapper primary-reason radio-width">
                        <div class="form-check form-check">
                          <label class="form-check-label" for="factor1">Recommendations from others</label>
                            <input class="form-check-input" type="checkbox" name="factor1" id="factor1" %%=v(@recommendations)=%% >                            
                        </div>
                        <div class="form-check form-check">
                          <label class="form-check-label" for="factor2">Online reviews</label>
                          <input class="form-check-input" type="checkbox" name="factor2" id="factor2" %%=v(@onlineReviews)=%% >
                        </div>
                        <div class="form-check form-check">
                          <label class="form-check-label" for="factor3">Promotional offers and discounts</label>
                          <input class="form-check-input" type="checkbox" name="factor3" id="factor3" %%=v(@promotionalOffers)=%% >
                        </div>
                        <div class="form-check form-check">
                          <label class="form-check-label" for="factor4">Exclusive events or activities</label>
                   <input class="form-check-input" type="checkbox" name="factor4" id="factor4" %%=v(@exclusiveEvents)=%% >
                       
                      </div>
                        <div class="form-check form-check">
                          <label class="form-check-label" for="factor5">Curiosity about the attraction</label>
                          <input class="form-check-input" type="checkbox" name="factor5" id="factor5" %%=v(@curiosity)=%% >
                        </div>
                    </div>
                    

                    <h4 class="pt-4 pb-3">What is the primary reason for your visit to The View Palm Jumeirah?</h4>
                    <div class="radio-wrapper often-visit radio-width">
                      <div class="form-check form-check">
                        <label class="form-check-label" for="reason1">On my Dubai bucket list</label>
                          <input class="form-check-input" type="checkbox" name="reason1" id="reason1" %%=v(@dubaiList)=%% >                  
                      </div>
                      <div class="form-check form-check">
                        <label class="form-check-label" for="reason2">I came with my friends/family</label>
                        <input class="form-check-input" type="checkbox" name="reason2" id="reason2" %%=v(@cameWithFamily)=%% >
                      </div>
                      <div class="form-check form-check">
                        <label class="form-check-label" for="reason3">I love unique attractions and experiences</label>
                        <input class="form-check-input" type="checkbox" name="reason3" id="reason3" %%=v(@loveAttractions)=%% >
                      </div>
                      <div class="form-check form-check">
                        <label class="form-check-label" for="reason4">I want to celebrate a special occasion (birthday, anniversary, etc.)</label>
                        <input class="form-check-input" type="checkbox" name="reason4" id="reason4" %%=v(@celebrateOccasion)=%% >
                      </div>
                     
                  </div>

                  <h4 class="pt-4 pb-3">What do you like the most about The View Palm Jumeirah?</h4>
                  <div class="radio-wrapper like-most radio-width">
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like1">Views from the deck</label>
                        <input class="form-check-input" type="checkbox" name="like1" id="like1"  %%=v(@views)=%% >                          
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like2">Views from the Next Level</label>
                      <input class="form-check-input" type="checkbox" name="like2" id="like2"  %%=v(@nextLevel)=%% >
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like3">The View Palm Jumeirah exhibition</label>
                      <input class="form-check-input" type="checkbox" name="like3" id="like3"  %%=v(@exhibition)=%% >
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like4">Food and beverage options</label>
                      <input class="form-check-input" type="checkbox" name="like4" id="like4"  %%=v(@food)=%% >
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like5">Souvenir shops</label>
                      <input class="form-check-input" type="checkbox" name="like5" id="like5"  %%=v(@Souvenir)=%% >
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like6">Interactive displays or exhibits</label>
...
SET @factorsInfluencingVisitValue = CONCAT(
  ...
  if not Empty(@factorsInfluencingVisitValue) then
    SET @updateRecord = UpdateSingleSalesforceObject(
    "Guest_Subscription__c", @guestId,
  ...
  if @methodType== 'Old' then
    Redirect(Concat("https://cloud.explore.insideburjalarab.com/TV_CPC_QA?sfid=", Base64Encode(@sfid), "#communications"))
  ELSE
    Redirect(CONCAT(CloudPagesURL(3624),@communications))
  ENDIF
ENDIF
]%%    
        ...
        <div class="tab-pane fade preferences-tab-content" id="communications" role="tabpanel" aria-labelledby="communications-tab">
          <div class="wrapper wrapper--w700">
            <form class="preferences-form" action="" method="post">
               ...
               <div class="form-check">
                   <input class="form-check-input" type="checkbox" value="%%=v(@newExperiences)=%%" id="informCheck13"  name="hearExperiences" %%=IIF(@newExperiences =='True' ,'checked', "" )=%%>
                   <label class="form-check-label" for="informCheck13">
                    New experiences and entertainment
                   </label>
               </div>
               <div class="form-check">
                   <input class="form-check-input" type="checkbox" value="%%=v(@newFood)=%%" id="informCheck14"  name="newFoodAndRestaurants" %%=IIF(@newFood =='True' ,'checked', "" )=%%>
                   <label class="form-check-label" for="informCheck14">
                    New food and restaurants
                   </label>
               </div>
               <div class="form-check">
                <input class="form-check-input" type="checkbox" value="%%=v(@customerSurvey)=%%" id="informCheck15"  name="hearSurvey" %%=IIF(@customerSurvey =='True' ,'checked', "" )=%%>
...
IF RequestParameter("submittedCommunications")==true then
  ...
  set @UpdatedExperiences =  RequestParameter("hearExperiences")
  set @UpdatedNewFoodAndRestaurants =  RequestParameter("newFoodAndRestaurants")
  ...
  IF NOT Empty(@sfid) THEN
    ...
    "New_experiences_and_entertainment__c", IIF(EMPTY(@UpdatedExperiences), 'False', 'True'),
    ...
    if @methodType== 'Old' then
      Redirect(Concat("https://cloud.explore.insideburjalarab.com/TV_ThankYou_QA?sfid=", Base64Encode(@sfid), "#ThankYou"))
    ELSE
    Redirect(CONCAT(CloudPagesURL(3661),@thankYouPage))
    ENDIF
  ENDIF
ENDIF
]%%
<!--channel preference block-->
          ...
          <!-- thank you pop up -->
          <div class="box-form mt-5" id="channel-preference" style="display:none; padding: 0px 40px 40px;">
            ...
            <div class="container">
              <div class="unsubscribe-wrapper form group">
                ...
                <div class="thankYou-text">
                  <p style="font-size:16px; line-height:18px; color:#000000; font-weight: bold;">Your channel subscription preferences have been successfully updated.
                  </p>
                  <p style="display: %%=IIF(@status == "Unsubscribed", "block", "none")=%%;font-size:16px; line-height:18px; color:#000000; font-weight: bold; padding-top:0rem;">Should you wish to receive our communications again, please subscribe through our <a href="https://www.theviewpalm.ae/en" style=
"color:#212529;text-decoration: underline;" target="_blank">website</a>!</p>
          ...
          <!-- channel preference block end -->
            <div class="mt-5 pl-2" style="font-size: 16px;">
              <p>If you wish to unsubscribe from all The View Palm Jumeirah communications please click on ‘Unsubscribe’.</p>
            </div>
...
ENDIF
           ...
           <div class="box-form mt-5" id="unsubscribe-all-reason">
            ...
            <form class="comment-form" action="" method="post">
              <span class="close-buttonAll" style="text-align: right; font-size: 30px; position: relative; left: 100%; top: 0; cursor: pointer; color:#00AF87;">×</span>
                <div class="container">
      <div class="unsubscribe-wrapper form group">
        <div class="thanYou-img mb-2">
            <img src="https://image.explore.theviewpalm.ae/lib/fe3111737364047a741c70/m/1/ae919054-260b-4edd-bab5-92bdc7412f60.png" alt="" class="banner-bg-img">
...
IF RequestParameter("unsubAll") == true then
  ...
  /*Redirect(Concat("https://cloud.explore.insideburjalarab.com/TV_ThankYou_QA?sfid=", Base64Encode(@sfid)))*/
   ...
   <div class="footer-container">
      <div class="footer-links-section">
         <ul class="general-links">
            <li>
               <div class="content">
                  <a href="tel:8008438439" target="_blank" class="icon " style="margin-right: 2px;">
                  <img class="icon phone-icon" src='https://image.explore.theviewpalm.ae/lib/fe3111737364047a741c70/m/1/9156b9ff-31bf-40c1-80de-05b3da245bed.png' alt='' title='Footer_Call_Icon'/>
                  </a>
                  <div class="description">
                     <span class="title">Inside UAE</span>
            ...
            <li>
               <div class="content">
                  ...
                  <img class="icon internet-icon" src='https://image.explore.theviewpalm.ae/lib/fe3111737364047a741c70/m/1/7efc0238-9701-48ab-a084-5a80c9cd5f2d.png' alt='' title='Footer_Globe_Icon'/>
                  </a>
                  <div class="description">
                     <span class="title">Outside UAE</span>
            ...
            <li>
               <div class="content">
                  ...
                  <img class="icon email-icon" src='https://image.explore.theviewpalm.ae/lib/fe3111737364047a741c70/m/1/734cbc2e-12d6-4a02-b8b6-2cf7e3856fe9.png' alt='' title='Footer_Email_Icon'/>
                  </a>
                  <div class="description">
                     <span class="title">For General queries</span>
                     <a href="mailto:info@theviewpalm.ae" target="_blank">Email Us</a>
                  </div>
               </div>
            </li>
            <li>
               <div class="content">
                  ...
                  <div class="description">
                     <span class="title">For Group bookings & Events</span>
                     <a href="mailto:sales@palmexperience.com" target="_blank">Email Us</a>
                  </div>
               </div>
            </li>
         </ul>
      ...
      <div class="copyright-section">
         <div class="copyright-text">Copyright 2024 The View Palm Jumeirah. All rights reserved. </div>
         <ul>
            <li class="footer-nav-item">
               <a target="_blank" href="https://www.google.com/maps/place/The+View+at+the+Palm/@25.1137006,55.1372063,17z/data=!3m1!4b1!4m6!3m5!1s0x3e5f6b13906bb90b:0x20050f2f23d1482d!8m2!3d25.1137006!4d55.1397812!16s%2Fg%2F11s4z1jh7n?entry=ttu">FIND US</a>
            </li>
            <li class="footer-nav-item">
               <a target="_blank" href="https://www.theviewpalm.ae/en/terms-conditions">Terms & Conditions</a>
            </li>
            <li class="footer-nav-item">
               <a target="_blank" href="https://privacy.dubaiholding.com/en/privacy-notice/customers---dubai-holding-entertainment-llc">Privacy Policy</a>
            </li>
         </ul>
      </div>
   </div>
        ...
        <!-- footer End -->                      
    <!-- Vendor JS-->
     <script src="https://cloud.explore.theviewpalm.ae/TV_QA_bootstrap.min.js"></script>
    <script src="https://cloud.explore.theviewpalm.ae/TV_QA_select2.min.js"></script>
    <script src="https://cloud.explore.theviewpalm.ae/TV_QA_moment.min.js"></script>
    <script src="https://cloud.explore.theviewpalm.ae/TV_QA_daterangepicker.js"></script>

    <!-- Main JS-->
    <script src="https://cloud.explore.theviewpalm.ae/TV_QA_custom.js"></script>
    <script src="https://cloud.explore.theviewpalm.ae/TV_QA_global.js"></script>
<script>
...
$(document).on("click", ".del", function() {
  ...
  console.log('deleted 2');
                ...
                $.ajax({
                    url: 'https://cloud.explore.theviewpalm.ae/TV_QA_KidsDelete', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
    ...
    /* if( emailPref.checked !='undefined'){
        ...
        console.log('whatsAppPref: ',whatsAppPref);
                ...
                $.ajax({
                    url: 'https://cloud.explore.theviewpalm.ae/TV_QA_ChannelPreference', // Replace with your CloudPage URL
      ...
      $("#unsubscribeClick").click(function(e) {
        ...
        var subsKey = document.getElementById('crmId').value;
                ...
                $.ajax({
                    url: 'https://cloud.explore.theviewpalm.ae/TV_QA_UnsubscribeFromBU', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
                        console.log('SFMC Code Resource called successfully.');
      ...
      $("#unsubscribeAllClick").click(function(e) {
       ...
       //var guestId = "a5LP8000000gKQXMA2";
        var guestId =document.getElementById("guestId").value;
                ...
                $.ajax({
                    url: 'https://cloud.explore.theviewpalm.ae/TV_QA_UnsubscribeFromAllBU', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
                        console.log('SFMC Code Resource called successfully.');
