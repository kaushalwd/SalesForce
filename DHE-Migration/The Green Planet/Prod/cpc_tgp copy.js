...
%%[
    ...
    IF @guestDetailsRowCount > 0 THEN /*Roxy*/
        ...
        set @primaryReasonForVisit = Field(@guestDetailsRow, "Primary_reason_visit_TGP__c")
        set @preferredvisitTime = Field(@guestDetailsRow, "How_often_do_you_visit_The_Green_Planet__c")
        set @howOftenVisit = Field(@guestDetailsRow, "How_often_do_you_visit_The_Green_Planet__c")
        set @howOftenVisit = ProperCase(@howOftenVisit)
        set @likeMostAbout = Field(@guestDetailsRow, "Like_the_most_about_the_TGP__c")
        ...
        /*Output(concat("<br>newproductoffering: ",@newproductoffering))*/
...
<!DOCTYPE html>
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
                                <title>The Green Planet™ Dubai</title>
 <link rel="icon" type="image/x-icon" href="https://image.explore.globalvillage.ae/lib/fe3511737364047c7c1571/m/1/2ac2dd06-ae44-4b91-b8e1-6e998ac0d3e2.png">
                                <link href='https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_bootstrap.min.css' rel='stylesheet'>
                                
                                <script type='text/javascript' src='https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_jquery.min.js'></script>
                             
                                <!-- Font special for pages-->
                                <link href="https://fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
                                <link href="https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_style.css" rel="stylesheet">
                                
                              
                               
                                <!-- Vendor CSS-->
                                <link href="https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_select2.min.css" rel="stylesheet" media="all">
...
.nav-pills .nav-link.active {
  color: #fff;
    background-color: #567F2E !important;
  ...
  Platform.Response.SetResponseHeader("Content-Security-Policy","script-src 'self' 'unsafe-inline' https://image.explore.thegreenplanetdubai.com https://cloud.explore.globalvillage.ae; frame-ancestors 'none'");
          ...
          <div class="container">
              <div class="row align-items-center" style="margin: 0 auto;">
                  <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                      <a href="https://thegreenplanetdubai.com/en" class="logo-link" target="_blank">
                          <img src="https://image.explore.thegreenplanetdubai.com/lib/fe3b117373640479751472/m/1/d4a69b5d-84ae-4e3c-be7b-5a58e8d67849.png"
                              alt="logo">
                      </a>
                  </div>
      ...
      <!-- Header End --><section class="banner">
                                  <div class="main-banner">
                                    <img src= "https://image.explore.thegreenplanetdubai.com/lib/fe3b117373640479751472/m/1/b47f55e3-209d-424d-83ff-b4dd12193572.jpg" alt="banner-img" class="responsive">
                                        </div>
                                        <div class="container">
              ...
              %%[
                                IF RequestParameter("submittedProfile")==true then
                                   ...
                                   if @methodType== 'Old' then
                                      Redirect(Concat("https://cloud.explore.thegreenplanetdubai.com/CPC_TGP?sfid=", Base64Encode(@sfid), "#interests"))
                                   ELSE
                                      Redirect(CONCAT(CloudPagesURL(2754),@interests))
                                   ENDIF
 ...
 %%[
                                   ...
                                   if @primaryReasonCount > 0 then
                                      for @i = 1 to @primaryReasonCount do
                                           ...
                                           IF @val == "To learn more about animals." THEN
                                           SET @learnMoreAboutAnimals = "checked"
                                           ELSEIF @val == "Fun family experience." THEN
                                           SET @funFamilyExperience = "checked"
                                           ELSEIF @val == "I have always wanted to visit The Green Planet." THEN
                                           SET @alwaysWantedToVisitTGP = "checked"
                                           ELSEIF @val == "I am a regular (Annual Pass Holder)" THEN
                                           SET @annualPassHolder = "checked"
                                           ELSEIF @val == "Participate in maintaining sustainability" THEN       
                                           SET @maintainingSustainability = "checked"
                                           ENDIF
                                           
                                      next @i
                                   endif
                    
                                  set @visitTimeString = BuildRowsetFromString(@preferredvisitTime,";")
                                  set @visitTimeCount = rowCount(@visitTimeString)
                                  
                                  if @visitTimeCount > 0 then
                                      for @i = 1 to @visitTimeCount do
                                           
                                           SET @val = Field(Row(@visitTimeString,@i),1)
                                           ...
                                           SET @twoTimes = "checked"
                                           ELSEIF @val == "Every few years" THEN
                                           SET @fewYears = "checked"
                                           ENDIF
                                  ...
                                  if @likeMostCount > 0 then
                                      for @i = 1 to @likeMostCount do
                                           ...
                                           IF @val == "The animals" THEN
                                           SET @animals = "checked"
                                           ELSEIF @val == "The biodome" THEN
                                           SET @biodome = "checked"
                                           ELSEIF @val == "Nature Park" THEN
                                           SET @park = "checked"
                                           ELSEIF @val == "The food offerings" THEN
                                           SET @food = "checked"
                                           ELSEIF @val == "The learning experience" THEN       
                                           SET @learning = "checked"
                                           ENDIF
        ...
        <div class="tab-pane fade interest-tab-content" id="interests" role="tabpanel" aria-labelledby="interests-tab">
            ...
            <div class="wrapper wrapper--w700">
              ...
              <form class="interest-form" action="" method="post" name="myForm" id="interest-form" autocomplete="off" >
                  ...
                  <div class="form-group">
                    <h4 class="pt-4 pb-3">What is the primary reason for your visit to The Green Planet™?</h4>
                    <div class="radio-wrapper primary-reason radio-width">
                        <div class="form-check form-check">
                          <label class="form-check-label" for="reason1">To learn more about animals.</label>
                            <input class="form-check-input" type="checkbox" name="reason1" id="reason1" %%=v(@learnMoreAboutAnimals)=%% >                            
                        </div>
                        <div class="form-check form-check">
                          <label class="form-check-label" for="reason2">Fun family experience.</label>
                          <input class="form-check-input" type="checkbox" name="reason2" id="reason2" %%=v(@funFamilyExperience)=%% >
                        </div>
                        <div class="form-check form-check">
                          <label class="form-check-label" for="reason3">I have always wanted to visit The Green Planet™.</label>
                          <input class="form-check-input" type="checkbox" name="reason3" id="reason3" %%=v(@alwaysWantedToVisitTGP)=%% >
                        </div>
                        <div class="form-check form-check">
                          <label class="form-check-label" for="reason4">I am a regular (Annual Pass Holder)</label>
                   <input class="form-check-input" type="checkbox" name="reason4" id="reason4" %%=v(@annualPassHolder)=%% >
                       
                      </div>
                        <div class="form-check form-check">
                          <label class="form-check-label" for="reason5">Participate in maintaining sustainability.</label>
                          <input class="form-check-input" type="checkbox" name="reason5" id="reason5" %%=v(@maintainingSustainability)=%% >
                        </div>
                    </div>
                    

                    <h4 class="pt-4 pb-3">How often do you visit The Green Planet™?</h4>
                    <div class="radio-wrapper often-visit radio-width">
                      ...
                      <div class="form-check form-check">
                        <label class="form-check-label" for="visit3">Two times per year</label>
                        <input class="form-check-input" type="radio" name="visit" id="visit3" value="Two times per year" %%=IIF(@howOftenVisit=='Two times per year', 'checked', '')=%% >
                      </div>
                      <div class="form-check form-check">
                        <label class="form-check-label" for="visit4">Every few years</label>
                        <input class="form-check-input" type="radio" name="visit" id="visit4" value="Every few years" %%=IIF(@howOftenVisit=='Every few years', 'checked', '')=%% >
                      </div>
                     
                  </div>

                  <h4 class="pt-4 pb-3">What do you like the most about The Green Planet™?</h4>
                  <div class="radio-wrapper like-most radio-width">
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like1">The animals</label>
                        <input class="form-check-input" type="checkbox" name="like1" id="like1" %%=v(@animals)=%% >                          
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like2">The biodome</label>
                      <input class="form-check-input" type="checkbox" name="like2" id="like2" %%=v(@biodome)=%% >
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like3">Nature Park</label>
                      <input class="form-check-input" type="checkbox" name="like3" id="like3" %%=v(@park)=%% >
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like4">The food offerings</label>
                      <input class="form-check-input" type="checkbox" name="like4" id="like4" %%=v(@food)=%% >
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="like5">The learning experience</label>
                      <input class="form-check-input" type="checkbox" name="like5" id="like5" %%=v(@learning)=%% >
                    </div>
                </div>
...
IF RequestParameter("submittedInterests") == "true" then
  ...
  Iif(RequestParameter("reason1") == "on", "To learn more about animals.;", ""),
  Iif(RequestParameter("reason2") == "on", "Fun family experience.;", ""),
  Iif(RequestParameter("reason3") == "on", "I have always wanted to visit The Green Planet.;", ""),
  Iif(RequestParameter("reason4") == "on", "I am a regular (Annual Pass Holder);", ""),
  Iif(RequestParameter("reason5") == "on", "Participate in maintaining sustainability", ""),
  )  
  if not Empty(@primaryReasonToVisitValue) then
    SET @updateRecord = UpdateSingleSalesforceObject(
    "Guest_Subscription__c", @guestId,
    "Primary_reason_visit_TGP__c", @primaryReasonToVisitValue)
  else
    SET @updateRecord = UpdateSingleSalesforceObject(
    "Guest_Subscription__c", @guestId,
    "fieldsToNull", "Primary_reason_visit_TGP__c")
  endif
  ...
  ELSEIF @oftenVisitValue == 'Every few years' THEN
    SET @OftenVisitUpdation = 'Every few years'
  ENDIF


  SET @updateRecords = UpdateSingleSalesforceObject(
  "Guest_Subscription__c", @guestId, 
  "How_often_do_you_visit_The_Green_Planet__c", @OftenVisitUpdation,
  )

  SET @likeMostAboutPreferences = CONCAT(
  Iif(RequestParameter("like1") == "on", "The animals;", ""),
  Iif(RequestParameter("like2") == "on", "The biodome;", ""),
  Iif(RequestParameter("like3") == "on", "Nature Park;", ""),
  Iif(RequestParameter("like4") == "on", "The food offerings;", ""),
  Iif(RequestParameter("like5") == "on", "The learning experience", ""),
  )  
  ...
  if not Empty(@likeMostAboutPreferences) then
    SET @updateRecord = UpdateSingleSalesforceObject(
    "Guest_Subscription__c", @guestId,
    "Like_the_most_about_the_TGP__c", @likeMostAboutPreferences)
  else
    SET @updateRecord = UpdateSingleSalesforceObject(
    "Guest_Subscription__c", @guestId,
    "fieldsToNull", "Like_the_most_about_the_TGP__c")
  endif 
  ...
  Set @p= InsertData("PreferencesLog","SubscriberKey",@sfid,"EmailAddress",@emailContact,"Submission","InterestPage","AMPError",@ampError,"FirstName",@firstName,"LastName",@lastName)

  if @methodType== 'Old' then
    Redirect(Concat("https://cloud.explore.thegreenplanetdubai.com/CPC_TGP?sfid=", Base64Encode(@sfid), "#communications"))
  ELSE
    Redirect(CONCAT(CloudPagesURL(2754),@communications))
  ENDIF
ENDIF
]%%    
        </div>
            ...
            <form class="preferences-form" action="" method="post">
               ...
               <div class="form-check">
                   ...
                   <label class="form-check-label" for="informCheck12">
                    Annual Pass/VIP Offers information
                   </label>
               </div>
               <div class="form-check">
...
IF RequestParameter("submittedCommunications")==true then
  ...
  IF NOT Empty(@sfid) THEN
    ...
    ELSE
      Set @ampError = ''
    ENDIF
    Set @p= InsertData("PreferencesLog","SubscriberKey",@sfid,"EmailAddress",@emailContact,"Submission","CommunicationPage","AMPError",@ampError,"FirstName",@firstName,"LastName",@lastName)
            ...
            <div class="container">
              <div class="unsubscribe-wrapper form group">
                ...
                <div class="thankYou-text">
                  ...
                  <p style="display: %%=IIF(@status == "Unsubscribed", "block", "none")=%%;font-size:16px; line-height:18px; color:#000000; font-weight: bold; padding-top:0rem;">Should you wish to receive our communications again, please subscribe through our <a href="https://thegreenplanetdubai.com/en" style=
"color:#212529;text-decoration: underline;" target="_blank">website</a>!</p>
          ...
          <!-- channel preference block end -->
            <div class="mt-5 pl-2" style="font-size: 16px;">
              <p>To manage SMS subscriptions, please refer to the opt-out feature from the latest SMS message. </p>
            </div>
...
top: 0;
cursor: pointer;                                                           
color:#567F2E;">×</span>  <div class="container">
      <div class="unsubscribe-wrapper form group">
        <div class="thanYou-img mb-2">
            <img src="https://image.explore.thegreenplanetdubai.com/lib/fe3b117373640479751472/m/1/274f476f-7123-4c2d-b8e7-aa0cce3c2cc3.png" alt="" class="banner-bg-img">
        </div>
...
IF RequestParameter("submittedUnsub")==true then
  ...
  IF NOT Empty(@sfid) THEN
    ...
    IF NOT Empty(@unsubTempBox) THEN
      SET @s = upsertData("ENT.TempPauseHandle_Prod", 1, "SubscriberKey", @guestId, "Email",
      @emailContact,"DateAdded",@currentDate,"ContactId",@sfid, "UnsubscribeType","Individual","Asset","TGP")
    ENDIF
    IF Empty(@unsubTempBox) THEN
      ...
      if @count > 0 then
        set @deleteCount = DeleteData("ENT.TempPauseHandle_Prod","Email", @emailContact)
        SET @updateRecord = UpdateSingleSalesforceObject(
        "Guest_Subscription__c", @guestId,
        "Temporary_Pause_30_Days__c", IIF(Empty(@unsubTempBox), 'False', 'True'), 
        "Emails_are_too_frequent__c", IIF(Empty(@unsubFreqBox), 'False', 'True'),
...
ENDIF
           ...
           <div class="box-form mt-5" id="unsubscribe-all-reason">
            ...
            <form class="comment-form" action="" method="post">
              <span class="close-buttonAll" style="text-align: right; font-size: 30px; position: relative; left: 100%; top: 0; cursor: pointer; color:#567F2E;">×</span>
                <div class="container">
      <div class="unsubscribe-wrapper form group">
        <div class="thanYou-img mb-2">
            <img src="https://image.explore.thegreenplanetdubai.com/lib/fe3b117373640479751472/m/1/274f476f-7123-4c2d-b8e7-aa0cce3c2cc3.png" alt="" class="banner-bg-img">
...
IF RequestParameter("unsubAll") == true then
  ...
  IF NOT Empty(@unsubTempBox) THEN
    ...
    SET @s = upsertData("ENT.TempPauseHandle_Prod", 1, "SubscriberKey", @guestId, "Email", @emailContact,"DateAdded",@currentDate,"ContactId",@sfid,"UnsubscribeType","All","Asset","TGP")

    /*Upsert data in resub DE to resubscriber contact on enterprise level*/

    SET @resub = upsertData("ENT.UnsubscribeHandle_Prod", 1, "SubscriberKey", @sfid, "EmailAddress", @emailContact, "SubsciberStatus", "Active","Temp_30_Days", "True","Frequency","False","Relevance","False","Not_In_Dubai","False","Other","False","Asset","TGP")
  ...
  ELSE
    ...
    ENDIF
      ...
      SET @resub = upsertData("ENT.UnsubscribeHandle_Prod", 1, "SubscriberKey", @sfid, "EmailAddress", @emailContact, "Frequency", IIF(Empty(@unsubFreqBox), 'False', 'True'),"Relevance", IIF(Empty(@unsubRelevanceBox), 'False', 'True'),"Not_In_Dubai", IIF(Empty(@unsubNoDubaiBox), 'False', 'True'),"Other", IIF(Empty(@unsubOtherBox), 'False', 'True'),"Temp_30_Days","False","Asset","TGP")
      set @rowFound = LookupRows("ENT.TempPauseHandle_Prod","SubscriberKey", @sfid)
      set @count = rowcount(@rowFound)
      if @count > 0 then
        set @deleteCount = DeleteData("ENT.TempPauseHandle_Prod","Email", @emailContact)
      ENDIF
  ...
  /*Redirect(Concat("https://cloud.explore.thegreenplanetdubai.com/Thankyou_TGP?sfid=", Base64Encode(@sfid)))*/
      ...
      <!-- footer 2 start -->
        ...
        <footer>
          ...
          <table style="width:100%;">
            <tfoot>
              <tr style="background-image:url(https://image.explore.thegreenplanetdubai.com/lib/fe3b117373640479751472/m/1/a7b3b54b-b0ed-40eb-a5ab-a168eed97af0.png);background-repeat:no-repeat; background-size: cover; padding-top: 10px;">
                <td align="center" class="pt-3">
                  <a class="pr-3"alias="Facebook" conversion="false" data-linkto="https://" href="https://www.facebook.com/TheGreenPlanetDubai/" title="Facebook" target="_blank"><img alt="" data-assetid="92559" height="30" src="https://image.explore.thegreenplanetdubai.com/lib/fe3b117373640479751472/m/1/cb3b6fd9-bca4-42ff-aabc-aa17833f395d.png" style="padding: 0px; width: 30px; text-align: center; height: 30px; border: 0px;" width="30"></a>
                  <a  class="pr-3" alias="Instagram" conversion="false" data-linkto="https://" href="https://www.instagram.com/thegreenplanetdubai/" title="Instagram" target="_blank"><img alt="" data-assetid="92558" height="30" src="https://image.explore.thegreenplanetdubai.com/lib/fe3b117373640479751472/m/1/df644177-a1c2-4c99-a5f3-7d934a131f93.png" style="padding: 0px; text-align: center; height: 30px; width: 30px; border: 0px;" width="30"></a>
                  <a alias="Youtube" conversion="false" data-linkto="https://" href="https://www.youtube.com/channel/UCUQpbDYNb9O8C80Wlqj_Eiw" title="Youtube" target="_blank"><img alt="" data-assetid="92571" height="30" src="https://image.explore.thegreenplanetdubai.com/lib/fe3b117373640479751472/m/1/d9933287-b847-4992-94f5-2b8f64261248.png" style="padding: 0px; text-align: center; height: 30px; width: 30px; border: 0px;" width="30"></a>
                  <p class="pt-2"style="font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:bold;color:#E4E4E4">For more information call <a alias="800-7699"  conversion="false" href="#" style="color:#E4E4E4;text-decoration:none;" title="800-7699" target="_blank">800-7699</a><br>
                    <a alias="www.thegreenplanetdubai.com"  conversion="false"  href="https://thegreenplanetdubai.com/en/" style="color:#E4E4E4;text-decoration:none;" title="www.thegreenplanetdubai.com" target="_blank">www.thegreenplanetdubai.com</a></p>
                   
                </td>
              </tr>
              <tr bgcolor="#C0EC78">
                <td style="text-align: center;">
                  <p class="pt-3"style="font-size: 12px; font-family: Arial, Helvetica, sans-serif; text-align: center;">
                    <a alias="Park Policies and Guidelines" conversion="false"  href="https://thegreenplanetdubai.com/en/information/park-rules" style="color:#000000;text-decoration:underline;padding: 20px;" title="Park Policies and Guidelines" target="_blank">Park Policies and Guidelines</a>
                    
                  
                
                      <a alias="Terms and Conditions" conversion="false" data-linkto="https://" href="https://thegreenplanetdubai.com/en/terms-and-conditions" style="color:#000000;text-decoration:underline; padding: 20px;" title="Terms and Conditions" target="_blank">Terms and Conditions</a></p>
                </td>
              </tr>
        ...
        <!-- footer End -->                      
    <!-- Vendor JS-->
     <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_bootstrap.min.js"></script>
    <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_select2.min.js"></script>
    <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_moment.min.js"></script>
    <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_daterangepicker.js"></script>

    <!-- Main JS-->
    <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_custom.js"></script>
    <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_global.js"></script>
<script>
...
$(document).on("click", ".del", function() {
  ...
  console.log('deleted 2');
                ...
                $.ajax({
                    url: 'https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_KidsDelete', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
...
//To call channel management code from BU resource
      $("#channelPreferencess").click(function(e) {
        ...
        console.log('whatsAppPref: ',whatsAppPref);
                ...
                $.ajax({
                    url: 'https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_ChannelPreference', // Replace with your CloudPage URL
      ...
      $("#unsubscribeClick").click(function(e) {
        ...
        var subsKey = document.getElementById('crmId').value;
                ...
                $.ajax({
                    url: 'https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_UnsubscribeFromBU', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
                        console.log('SFMC Code Resource called successfully.');
      ...
      $("#unsubscribeAllClick").click(function(e) {
       ...
       //var guestId = "a5LP8000000gKQXMA2";
        var guestId =document.getElementById("guestId").value;
                ...
                $.ajax({
                    url: 'https://cloud.explore.thegreenplanetdubai.com/TGP_Prod_UnsubscribeFromAllBU', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
                        console.log('SFMC Code Resource called successfully.');
