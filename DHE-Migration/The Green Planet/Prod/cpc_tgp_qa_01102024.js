...
%%[
    ...
    "Contact__c", "=", @crmId,"Asset__c","=","The Green Planet")
              ...
              %%[
                                IF RequestParameter("submittedProfile")==true then
                                   ...
                                   if @methodType== 'Old' then
                                      Redirect(Concat("https://cloud.explore.thegreenplanetdubai.com/TGP_CPC_QA?sfid=", Base64Encode(@sfid), "#interests"))
                                   ELSE
...
IF RequestParameter("submittedInterests") == "true" then
  ...
  if @methodType== 'Old' then
    Redirect(Concat("https://cloud.explore.thegreenplanetdubai.com/TGP_CPC_QA?sfid=", Base64Encode(@sfid), "#communications"))
  ELSE
     ...
     //To call channel management code from BU resource
      $("#channelPreferencess").click(function(e) {
        ...
        console.log('whatsAppPref: ',whatsAppPref);
                ...
                $.ajax({
                    url: 'https://cloud.explore.thegreenplanetdubai.com/TGP_QA_ChannelPreference', // Replace with your CloudPage URL
