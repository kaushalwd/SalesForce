...
<!-- START : Changes done on 02-09-2024 for DHE-8087 from Kaushal Patel -->
        // set @getintouch = Field(@guestDetailsRow, "How_should_we_get_in_touch__c")
...
<script runat="server">
  Platform.Load("core", "1.1.2");
        ...
        var submittedGetintouch = Platform.Request.GetFormField('submittedGetintouch') || "";
...
<!DOCTYPE html>
 ...
 <link rel="icon" type="image/x-icon" href="https://image.explore.globalvillage.ae/lib/fe3511737364047c7c1571/m/1/2ac2dd06-ae44-4b91-b8e1-6e998ac0d3e2.png">
                                <link href='https://cloud.explore.thegreenplanetdubai.com/TGP_QA_bootstrap.min.css' rel='stylesheet'>
                                
                                <script type='text/javascript' src='https://cloud.explore.thegreenplanetdubai.com/TGP_QA_jquery.min.js'></script>
                             
                                <!-- Font special for pages-->
                                <link href="https://fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
                                <link href="https://cloud.explore.thegreenplanetdubai.com/TGP_QA_style.css" rel="stylesheet">
                                
                              
                               
                                <!-- Vendor CSS-->
                                <link href="https://cloud.explore.thegreenplanetdubai.com/TGP_QA_select2.min.css" rel="stylesheet" media="all">
...
<!-- START : Changes done on 02-09-2024 for DHE-8087 from Kaushal Patel -->
           <form class="getintouch-form" action="" method="post">
            <div class="get-in-touch">
                <h4 class="pt-4 pb-3">How should we get in touch?</h4>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="%%=v(@getinTouchEmail)=%%" id="getinTouch11" name="getinTouchEmail" %%=IIF(@getinTouchEmail =='True' ,'checked',"")=%% >
                    <label class="form-check-label" for="getinTouch11">
                    Email
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="%%=v(@getinTouchWhatsapp)=%%" id="getinTouch12" name="getinTouchWhatsapp" %%=IIF(@getinTouchWhatsApp =='True','checked',"")=%% >
                    <label class="form-check-label" for="getinTouch12">
                    WhatsApp
                    </label>
                </div>
            </div>
            <div class="com-btn mt-5">
                <button type="submit" class="btn btn-orange" id="getintouch-submit" name="button">Save</button>
            </div>
            <input name="submittedGetintouch" type="hidden" value="true">
            <input name="crmId" type="hidden" value="%%=v(@crmId)=%%">
             <input name="guestId" type="hidden" value="%%=v(@Id)=%%"><br>
             <input name="emails" type="hidden" value="%%=v(@email)=%%">
        </form>
...
<!-- START : Changes done on 2 09 2024 for DHE-8087 from Kaushal Patel -->

%%[
    IF RequestParameter("submittedGetintouch")==true then
    
      SET @sfid = RequestParameter("crmId")
      SET @guestId = RequestParameter("guestId")
      SET @emailContact = RequestParameter("emails")
      SET @UpdatedEmailPref =  RequestParameter("getintouchEmail")
      SET @UpdatedWhatsappPref =  RequestParameter("getintouchWhatsapp")
    
    
      IF NOT Empty(@sfid) THEN
        SET @updateRecord = UpdateSingleSalesforceObject(
        "Guest_Subscription__c", @guestId,
        "Email__c", IIF(EMPTY(@UpdatedEmailPref), 'False', 'True'), 
        "WhatsApp__c", IIF(EMPTY(@UpdatedWhatsappPref), 'False', 'True')
        )
        ...
        ELSE
          Set @ampError = ''
        ENDIF
        Set @p= InsertData("PreferencesLog_Test","SubscriberKey",@sfid,"EmailAddress",@emailContact,"Submission","CommunicationPage-GetInTouch","AMPError",@ampError,"FirstName",@firstName,"LastName",@lastName)
...
IF RequestParameter("unsubAll") == true then
  ...
  IF NOT Empty(@unsubTempBox) THEN
    ...
    SET @s = upsertData("ENT.TempPauseHandle_QA", 1, "SubscriberKey", @guestId, "Email", @emailContact,"DateAdded",@currentDate,"ContactId",@sfid,"UnsubscribeType","All","Asset","TGP")

    /*Upsert data in resub DE to resubscriber contact on enterprise level*/

    SET @resub = upsertData("ENT.UnsubscribeHandle_QA", 1, "SubscriberKey", @sfid, "EmailAddress", @emailContact, "SubsciberStatus", "Active","Temp_30_Days", "True","Frequency","False","Relevance","False","Not_In_Dubai","False","Other","False","Asset","TGP")
  ...
  /*Redirect(Concat("https://cloud.explore.thegreenplanetdubai.com/TGP_ThankYou_QA?sfid=", Base64Encode(@sfid)))*/
...
<div class="loaderimg1">Loading...</div>
      ...
      <!-- footer 2 start -->
        ...
        <!-- footer End -->                      
    <!-- Vendor JS-->
     <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_QA_bootstrap.min.js"></script>
    <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_QA_select2.min.js"></script>
    <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_QA_moment.min.js"></script>
    <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_QA_daterangepicker.js"></script>

    <!-- Main JS-->
    <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_QA_custom.js"></script>
    <script src="https://cloud.explore.thegreenplanetdubai.com/TGP_QA_global.js"></script>
<script>
...
$(document).on("click", ".del", function() {
  ...
  console.log('deleted 2');
                ...
                $.ajax({
                    url: 'https://cloud.explore.thegreenplanetdubai.com/TGP_QA_KidsDelete', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
     ...
     function updateUrlHash(hash) {
      ...
      $("#unsubscribeClick").click(function(e) {
        ...
        var subsKey = document.getElementById('crmId').value;
                ...
                $.ajax({
                    url: 'https://cloud.explore.thegreenplanetdubai.com/TGP_QA_UnsubscribeFromBU', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
                        console.log('SFMC Code Resource called successfully.');
      ...
      $("#unsubscribeAllClick").click(function(e) {
       ...
       //var guestId = "a5LP8000000gKQXMA2";
        var guestId =document.getElementById("guestId").value;
                ...
                $.ajax({
                    url: 'https://cloud.explore.thegreenplanetdubai.com/TGP_QA_UnsubscribeFromAllBU', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
                        console.log('SFMC Code Resource called successfully.');
