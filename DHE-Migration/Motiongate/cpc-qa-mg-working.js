...
%%[
    ...
    /*Set @contactRows =
    RetrieveSalesforceObjects("Contact","Title,FirstName,LastName,Email,Mobile_Code__c,MobilePhone,Date_of_Birth__c,Language__c,Country__c,Nationality__c,Marital_Status__c,No_of_Kids__c,Gender__c,City__c,Do_you_have_kids__c",
    "Id","=", @crmId)*/
    ...
    SET @GuestDetails =
    RetrieveSalesforceObjects("Guest_Subscription__c","Asset__c,
    Id,What_Is_primary_reason_for_your_visit__c,How_often_do_you_visit_this_asset__c,What_do_you_like_the_most_about__c,Offers_and_Promotions__c,New_rides_and_entertainment__c,New_food_and_restaurants__c,
    Hotels_and_resorts__c,Upcoming_events_for_families__c,Customer_Survey__c,Email__c,WhatsApp__c,Emails_are_too_frequent__c,Content_isn_t_relevant__c,I_m_no_longer_in_Dubai__c,Temporary_Pause_30_Days__c,Other_Please_specify__c,Reason_of_Unsubscribe__c",
    "Contact__c", "=", @crmId,"Asset__c","=","Dubai Parks and Resorts","Sub_Asset__c","=","Motiongate")
    SET @guestDetailsRowCount = Rowcount(@GuestDetails)
    IF @guestDetailsRowCount > 0 THEN
    
    SET @guestDetailsRow = Row(@GuestDetails, 1)
    /*set @monthlySpendAmount = Field(@guestDetailsRow, "How_Much_spend_on_entertainment_monthly__c")*/
    ...
    /*Output(concat("<br>@reasonForUnsub: ", @reasonForUnsub))*/
    ...
    <script runat="server">
      ...
      var profileMarried = Platform.Request.GetFormField('maritalstatus') || "";
      ...
      var listOfInput = [];
      listOfInput.push({
        Name: 'Motiongate - Offers and Promotions', Status: listOffers
      }
      )
      listOfInput.push({
        Name: 'Motiongate - Upcoming events for families', Status: listEvents
      }
      )
      listOfInput.push({
        Name: 'Motiongate - New rides and entertainment', Status: listRides
      }
      )
      listOfInput.push({
        Name: 'Motiongate - New food and restaurants', Status: listFood
      }
      )
      listOfInput.push({
        Name: 'Motiongate - Hotels and resorts', Status: listHotels
      }
      )
      listOfInput.push({
        Name: 'Motiongate - Customer Survey', Status: listCustomer
      }
      )
      if (subscriberKey) {
    ...
    <head>
      ...
      <title>Motiongate&trade; Theme Park Dubai</title>
      <link rel="icon" type="image/x-icon"
        href="https://image.explore.globalvillage.ae/lib/fe3511737364047c7c1571/m/1/fa725975-1920-4a95-93f3-c17f89765b80.png">
      <link href='https://cloud.explore.motiongatedubai.com/bootstrap.min_qa' rel='stylesheet'>
      <script type='text/javascript' src='https://cloud.explore.motiongatedubai.com/jqueryV2.min_qa'></script>
      <link href="https://cloud.explore.motiongatedubai.com/material-design-iconic-font.min_qa" rel="stylesheet"
        media="all">
      <link href="https://cloud.explore.motiongatedubai.com/font-awesome.min_qa" rel="stylesheet" media="all">
      <!-- Font special for pages-->
      <link
        href="https://fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">
      <link href="https://cloud.explore.motiongatedubai.com/style_qa" rel="stylesheet">
      <link href="https://cloud.explore.motiongatedubai.com/font_qa">
      <!-- Vendor CSS-->
      <link href="https://cloud.explore.motiongatedubai.com/select2.min_qa" rel="stylesheet" media="all">
      <link href="https://cloud.explore.motiongatedubai.com/daterangepicker_qa" rel="stylesheet" media="all">
      <style>
        /* nav */
        .card {
          max-width: 90rem;
        ...
        .nav-pills .nav-link.active {
          color: #fff;
          background-color: #069fda !important;
          font-weight: 700;
        }
    ...
    <script runat=server>
      ...
      Platform.Response.SetResponseHeader("Content-Security-Policy","script-src 'self' 'unsafe-inline' https://image.explore.motiongatedubai.com https://cloud.explore.globalvillage.ae; frame-ancestors 'none'");
    ...
    <body onload="handleNumOfKidsChange(%%=v(@numOfKids)=%%); kidsPrepopulation(); ShowHideDivkids(); validateForm();">
        ...
        <div class="container">
          <div class="row align-items-center" style="margin: 0 auto;">
            <div class="col-lg-8 col-md-8 col-sm-8 col-8">
              <a href="https://www.motiongatedubai.com/en" class="logo-link" target="_blank">
                <img
                  src="https://image.explore.motiongatedubai.com/lib/fe39117373640479751474/m/1/0c3a6ae8-4ee6-42d2-b8e1-5ffb07df88f2.png"
                  alt="logo">
              </a>
            </div>
      ...
      <section class="banner">
        <div class="main-banner">
          <img
            src="https://image.explore.motiongatedubai.com/lib/fe39117373640479751474/m/1/8303a721-727d-417e-896f-9d8c5458e9fc.png"
            alt="banner-img" class="responsive" id="desktop-img"> <img
            src="https://image.explore.motiongatedubai.com/lib/fe39117373640479751474/m/1/3ec8c186-3a0e-45f9-a512-c98a46e0012f.png"
            alt="banner-img" class="responsive" id="mob-img">
        </div>
        <div class="container">
      ...
      <div class="container card content-wrapper">
        ...
        <ul class="nav nav-pills mb-3 d-flex justify-content-center" id="pills-tab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="my-profile-tab" data-toggle="pill" href="#my-profile" role="tab"
              aria-controls="my-profile" aria-selected="true" onclick="updateUrlHash('#my-profile')"> MY PROFILE</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="interests-tab" data-toggle="pill" href="#interests" role="tab" aria-controls="interests"
              aria-selected="false" onclick="updateUrlHash('#interests')">INTERESTS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="communications-tab" data-toggle="pill" href="#communications" role="tab"
              aria-controls="communications" aria-selected="false"
              onclick="updateUrlHash('#communications')">COMMUNICATIONS</a>
          </li>
        </ul>
        <!-- content -->
        <div class="tab-content" id="pills-tabContent p-3">
          ...
          <div class="tab-pane fade show active" id="my-profile" role="tabpanel" aria-labelledby="my-profile-tab">
            <div class="wrapper wrapper--w1200">
              <form class="profile-form" action="%%=RequestParameter('PAGEURL')=%%" method="post" name="myForm"
                id="profile-form" autocomplete="off" onsubmit="return moveToTab(2)">
                <h4 class="pt-4 pb-4">Tell us about yourself
                </h4>
                <div class="row">
                    ...
                    <div class="form-group" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
                      ...
                      <div class="select-wrapper hide-icon">
                        <select class="form-control" name="profileSalutation">
                          ...
                          <option value="Mrs." %%=IIF(@title=='Mrs.' ,'selected', "" )=%%>
                            Mrs.
                          </option>
                        </select>
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="form-group" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
                      ...
                      <input type="email" id="email" name="email" value="%%=v(@email)=%%" class="form-control" required
                        aria-required="true" />
                    </div>
                  </div>
                      ...
                      <div class="input-group mb-3">
                        <div class="select-wrapper hide-icon">
                          <div class="input-group-prepend">
                            <input type="text" class="form-control" list="codedatalistOptions" name="lang" id="country-code"
                              placeholder="+971" value="%%=v(@mobilePhoneCode)=%%" required>
                        ...
                        <input name="phone" type="tel" class="form-control phone-inteltel" id="phone1" pattern="[0-9]{9,10}"
                          title="Phone number should be between 9-10 digits" value="%%=v(@Phone)=%%" required/>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="form-group" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
                      ...
                      <div class="select-wrapper hide-icon profilecountry">
                        <select class="form-control" name="profileCountry" id="profileCountry" required>
                          ...
                          <option value="Afghanistan" %%=IIF(@country=='Afghanistan' , "selected" , "" )=%%>Afghanistan
                          </option>
                          <option value="Aland Islands" %%=IIF(@country=='Aland Islands' , 'selected' , "" )=%%>Aland
                            Islands</option>
                          ...
                          <option value="American Samoa" %%=IIF(@country=='American Samoa' , "selected" , "" )=%%>American
                            Samoa</option>
                          <option value="Andorra" %%=IIF(@country=='Andorra' , "selected" , "" )=%%>Andorra</option>
                          <option value="Angola" %%=IIF(@country=='Angola' , "selected" , "" )=%%>
                            Angola</option>
                          <option value="Anguilla" %%=IIF(@country=='Anguilla' , "selected" , "" )=%%>Anguilla</option>
                          <option value="Antarctica" %%=IIF(@country=='Antarctica' , "selected" , "" )=%%>Antarctica
                          </option>
                          <option value="Antigua And Barbuda" %%=IIF(@country=='Antigua And Barbuda' , "selected" , "" )=%%>
                          ...
                          <option value="Aruba" %%=IIF(@country=='Aruba' , "selected" , "" )=%%>
                            Aruba</option>
                          ...
                          <option value="Azerbaijan" %%=IIF(@country=='Azerbaijan' , "selected" , "" )=%%>Azerbaijan
                          </option>
                          <option value="Bahamas The" %%=IIF(@country=='Bahamas The' , "selected" , "" )=%%>Bahamas The
                          </option>
                          <option value="Bahrain" %%=IIF(@country=='Bahrain' , "selected" , "" )=%%>Bahrain</option>
                          <option value="Bangladesh" %%=IIF(@country=='Bangladesh' , "selected" , "" )=%%>Bangladesh
                          </option>
                          ...
                          <option value="Belize" %%=IIF(@country=='Belize' , "selected" , "" )=%%>
                            Belize</option>
                          <option value="Benin" %%=IIF(@country=='Benin' , "selected" , "" )=%%>
                            Benin</option>
                          <option value="Bermuda" %%=IIF(@country=='Bermuda' , "selected" , "" )=%%>Bermuda</option>
                          <option value="Bhutan" %%=IIF(@country=='Bhutan' , "selected" , "" )=%%>
                            Bhutan</option>
                          <option value="Bolivia" %%=IIF(@country=='Bolivia' , "selected" , "" )=%%>Bolivia</option>
                          <option value="Bonaire Sint Eustatius and Saba" %%=IIF(@country=='Bonaire Sint Eustatius and Saba'
                            , "selected" , "" )=%%>Bonaire, Sint Eustatius
                            and Saba</option>
                          <option value="Bosnia and Herzegovina" %%=IIF(@country=='Bosnia and Herzegovina' , "selected" , ""
                            )=%%>
                            Bosnia and Herzegovina</option>
                          <option value="Botswana" %%=IIF(@country=='Botswana' , "selected" , "" )=%%>Botswana</option>
                          <option value="Bouvet Island" %%=IIF(@country=='Bouvet Island' , "selected" , "" )=%%>Bouvet
                            Island</option>
                          <option value="Brazil" %%=IIF(@country=='Brazil' , "selected" , "" )=%%>
                            Brazil</option>
                          <option value="British Indian Ocean Territory" %%=IIF(@country=='British Indian Ocean Territory'
                            , "selected" , "" )=%%>British Indian Ocean
                            Territory</option>
                          <option value="Brunei" %%=IIF(@country=='Brunei' , "selected" , "" )=%%>
                            Brunei</option>
                          <option value="Bulgaria" %%=IIF(@country=='Bulgaria' , "selected" , "" )=%%>Bulgaria</option>
                          <option value="Burkina Faso" %%=IIF(@country=='Burkina Faso' , "selected" , "" )=%%>Burkina Faso
                          </option>
                          ...
                          <option value="Canada" %%=IIF(@country=='Canada' , "selected" , "" )=%%>
                            Canada</option>
                          <option value="Cape Verde" %%=IIF(@country=='Cape Verde' , "selected" , "" )=%%>Cape Verde
                          </option>
                          <option value="Cayman Islands" %%=IIF(@country=='Cayman Islands' , "selected" , "" )=%%>Cayman
                            Islands</option>
                          <option value="Central African Republic" %%=IIF(@country=='Central African Republic' ,
                            selected, "" )=%%>
                            Central African Republic
                          </option>
                          <option value="Chad" %%=IIF(@country=='Chad' , "selected" , "" )=%%>Chad
                          </option>
                          <option value="Chile" %%=IIF(@country=='Chile' , "selected" , "" )=%%>
                            Chile</option>
                          <option value="China" %%=IIF(@country=='China' , "selected" , "" )=%%>
                            China</option>
                          <option value="Christmas Island" %%=IIF(@country=='Christmas Island' , "selected" , "" )=%%>
                            Christmas Island</option>
                          <option value="Cocos (Keeling) Islands" %%=IIF(@country=='Cocos (Keeling) Islands' , "selected"
                            , "" )=%%>
                          ...
                          <option value="Congo" %%=IIF(@country=='Congo' , "selected" , "" )=%%>
                            Congo</option>
                          <option value="Congo The Democratic Republic Of The"
                            %%=IIF(@country=='Congo The Democratic Republic Of The' , "selected" , "" )=%%>Congo The
                            Democratic Republic Of The</option>
                          <option value="Cook Islands" %%=IIF(@country=='Cook Islands' , "selected" , "" )=%%>Cook Islands
                          </option>
                          <option value="Costa Rica" %%=IIF(@country=='Costa Rica' , "selected" , "" )=%%>Costa Rica
                          </option>
                          <option value="Cote D'Ivoire (Ivory Coast)" %%=IIF(@country=="Cote D'Ivoire (Ivory Coast)"
                            , "selected" , "" )=%%>Cote D'Ivoire (Ivory Coast)
                          </option>
                          <option value="Croatia (Hrvatska)" %%=IIF(@country=='Croatia (Hrvatska)' , "selected" , "" )=%%>
                            Croatia (Hrvatska)</option>
                          <option value="Cuba" %%=IIF(@country=='Cuba' , "selected" , "" )=%%>
                            Cuba</option>
                          <option value="CuraÃ§ao" %%=IIF(@country=='CuraÃ§ao' , "selected" , "" )=%%>CuraÃ§ao</option>
                          <option value="Cyprus" %%=IIF(@country=='Cyprus' , "selected" , "" )=%%>
                            Cyprus</option>
                          <option value="Czech Republic" %%=IIF(@country=='Czech Republic' , "selected" , "" )=%%>Czech
                            Republic</option>
                          ...
                          <option value="Dominican Republic" %%=IIF(@country=='Dominican Republic' , "selected" , "" )=%%>
                            Dominican Republic</option>
                          <option value="East Timor" %%=IIF(@country=='East Timor' , "selected" , "" )=%%>East Timor
                          </option>
                          <option value="Ecuador" %%=IIF(@country=='Ecuador' , "selected" , "" )=%%>Ecuador</option>
                          <option value="Egypt" %%=IIF(@country=='Egypt' , "selected" , "" )=%%>
                            Egypt</option>
                          <option value="El Salvador" %%=IIF(@country=='El Salvador' , "selected" , "" )=%%>El Salvador
                          </option>
                          <option value="Equatorial Guinea" %%=IIF(@country=='Equatorial Guinea' , "selected" , "" )=%%>
                          ...
                          <option value="Falkland Islands" %%=IIF(@country=='Falkland Islands' , "selected" , "" )=%%>
                            Falkland Islands</option>
                          <option value="Faroe Islands" %%=IIF(@country=='Faroe Islands' , "selected" , "" )=%%>Faroe
                            Islands</option>
                          <option value="Fiji Islands" %%=IIF(@country=='Fiji Islands' , "selected" , "" )=%%>Fiji Islands
                          </option>
                          <option value="Finland" %%=IIF(@country=='Finland' , "selected" , "" )=%%>Finland</option>
                          <option value="France" %%=IIF(@country=='France' , "selected" , "" )=%%>
                            France</option>
                          <option value="French Guiana" %%=IIF(@country=='French Guiana' , "selected" , "" )=%%>French
                            Guiana</option>
                          <option value="French Polynesia" %%=IIF(@country=='French Polynesia' , "selected" , "" )=%%>French
                            Polynesia</option>
                          <option value="French Southern Territories" %%=IIF(@country=='French Southern Territories'
                            , "selected" , "" )=%%>French Southern Territories
                          </option>
                          <option value="Gabon" %%=IIF(@country=='Gabon' , "selected" , "" )=%%>
                            Gabon</option>
                          <option value="Gambia The" %%=IIF(@country=='Gambia The' , "selected" , "" )=%%>Gambia The
                          </option>
                          ...
                          <option value="Ghana" %%=IIF(@country=='Ghana' , "selected" , "" )=%%>
                            Ghana</option>
                          <option value="Gibraltar" %%=IIF(@country=='Gibraltar' , "selected" , "" )=%%>Gibraltar</option>
                          <option value="Greece" %%=IIF(@country=='Greece' , "selected" , "" )=%%>
                            Greece</option>
                          ...
                          <option value="Guadeloupe" %%=IIF(@country=='Guadeloupe' , "selected" , "" )=%%>Guadeloupe
                          </option>
                          <option value="Guam" %%=IIF(@country=='Guam' , "selected" , "" )=%%>Guam
                          </option>
                          <option value="Guatemala" %%=IIF(@country=='Guatemala' , "selected" , "" )=%%>Guatemala</option>
                          <option value="Guernsey and Alderney" %%=IIF(@country=='Guernsey and Alderney' , "selected" , ""
                            )=%%>
                            Guernsey and Alderney</option>
                          <option value="Guinea" %%=IIF(@country=='Guinea' , "selected" , "" )=%%>
                            Guinea</option>
                          <option value="Guinea-Bissau" %%=IIF(@country=='Guinea-Bissau' , "selected" , "" )=%%>
                            Guinea-Bissau</option>
                          <option value="Guyana" %%=IIF(@country=='Guyana' , "selected" , "" )=%%>
                            Guyana</option>
                          <option value="Haiti" %%=IIF(@country=='Haiti' , "selected" , "" )=%%>
                            Haiti</option>
                          <option value="Heard Island and McDonald Islands"
                            %%=IIF(@country=='Heard Island and McDonald Islands' , "selected" , "" )=%%>Heard Island and
                            McDonald Islands</option>
                          <option value="Honduras" %%=IIF(@country=='Honduras' , "selected" , "" )=%%>Honduras</option>
                          <option value="Hong Kong S.A.R." %%=IIF(@country=='Hong Kong S.A.R.' , "selected" , "" )=%%>Hong
                            Kong S.A.R.</option>
                          ...
                          <option value="India" %%=IIF(@country=='India' , "selected" , "" )=%%>
                            India</option>
                          <option value="Indonesia" %%=IIF(@country=='Indonesia' , "selected" , "" )=%%>Indonesia</option>
                          <option value="Iran" %%=IIF(@country=='Iran' , "selected" , "" )=%%>Iran
                          </option>
                          <option value="Iraq" %%=IIF(@country=='Iraq' , "selected" , "" )=%%>Iraq
                          </option>
                          <option value="Ireland" %%=IIF(@country=='Ireland' , "selected" , "" )=%%>Ireland</option>
                          <option value="Israel" %%=IIF(@country=='Israel' , "selected" , "" )=%%>
                            Israel</option>
                          <option value="Italy" %%=IIF(@country=='Italy' , "selected" , "" )=%%>
                            Italy</option>
                          <option value="Jamaica" %%=IIF(@country=='Jamaica' , "selected" , "" )=%%>Jamaica</option>
                          <option value="Japan" %%=IIF(@country=='Japan' , "selected" , "" )=%%>
                            Japan</option>
                          <option value="Jersey" %%=IIF(@country=='Jersey' , "selected" , "" )=%%>
                            Jersey</option>
                          <option value="Jordan" %%=IIF(@country=='Jordan' , "selected" , "" )=%%>
                            Jordan</option>
                          <option value="Kazakhstan" %%=IIF(@country=='Kazakhstan' , "selected" , "" )=%%>Kazakhstan
                          </option>
                          <option value="Kenya" %%=IIF(@country=='Kenya' , "selected" , "" )=%%>
                            Kenya</option>
                          <option value="Kiribati" %%=IIF(@country=='Kiribati' , "selected" , "" )=%%>Kiribati</option>
                          <option value="Korea North" %%=IIF(@country=='Korea North' , "selected" , "" )=%%>Korea North
                          </option>
                          <option value="Korea South" %%=IIF(@country=='Korea South' , "selected" , "" )=%%>Korea South
                          </option>
                          <option value="Kosovo" %%=IIF(@country=='Kosovo' , "selected" , "" )=%%>
                            Kosovo</option>
                          <option value="Kuwait" %%=IIF(@country=='Kuwait' , "selected" , "" )=%%>
                            Kuwait</option>
                          <option value="Kyrgyzstan" %%=IIF(@country=='Kyrgyzstan' , "selected" , "" )=%%>Kyrgyzstan
                          </option>
                          <option value="Laos" %%=IIF(@country=='Laos' , "selected" , "" )=%%>Laos
                          </option>
                          <option value="Latvia" %%=IIF(@country=='Latvia' , 'selected' , "" )=%%>
                            Latvia</option>
                          ...
                          <option value="Libya" %%=IIF(@country=='Libya' , "selected" , "" )=%%>
                            Libya</option>
                          <option value="Liechtenstein" %%=IIF(@country=='Liechtenstein' , "selected" , "" )=%%>
                            Liechtenstein</option>
                          <option value="Lithuania" %%=IIF(@country=='Lithuania' , "selected" , "" )=%%>Lithuania</option>
                          <option value="Luxembourg" %%=IIF(@country=='Luxembourg' , "selected" , "" )=%%>Luxembourg
                          </option>
                          <option value="Macau S.A.R." %%=IIF(@country=='Macau S.A.R.' , "selected" , "" )=%%>Macau S.A.R.
                          </option>
                          <option value="Macedonia" %%=IIF(@country=='Macedonia' , "selected" , "" )=%%>Macedonia</option>
                          <option value="Madagascar" %%=IIF(@country=='Madagascar' , "selected" , "" )=%%>Madagascar
                          </option>
                          <option value="Malawi" %%=IIF(@country=='Malawi' , "selected" , "" )=%%>
                            Malawi</option>
                          ...
                          <option value="Mali" %%=IIF(@country=='Mali' , "selected" , "" )=%%>Mali
                          </option>
                          <option value="Malta" %%=IIF(@country=='Malta' , "selected" , "" )=%%>
                            Malta</option>
                          <option value="Man (Isle of)" %%=IIF(@country=='Man (Isle of)' , "selected" , "" )=%%>Man (Isle
                            of)</option>
                          <option value="Marshall Islands" %%=IIF(@country=='Marshall Islands' , "selected" , "" )=%%>
                            Marshall Islands</option>
                          <option value="Martinique" %%=IIF(@country=='Martinique' , "selected" , "" )=%%>Martinique
                          </option>
                          <option value="Mauritania" %%=IIF(@country=='Mauritania' , "selected" , "" )=%%>Mauritania
                          </option>
                          ...
                          <option value="Mexico" %%=IIF(@country=='Mexico' , "selected" , "" )=%%>
                            Mexico</option>
                          <option value="Micronesia" %%=IIF(@country=='Micronesia' , "selected" , "" )=%%>Micronesia
                          </option>
                          <option value="Moldova" %%=IIF(@country=='Moldova' , "selected" , "" )=%%>Moldova</option>
                          <option value="Monaco" %%=IIF(@country=='Monaco' , "selected" , "" )=%%>
                            Monaco</option>
                          <option value="Mongolia" %%=IIF(@country=='Mongolia' , "selected" , "" )=%%>Mongolia</option>
                          <option value="Montenegro" %%=IIF(@country=='Montenegro' , "selected" , "" )=%%>Montenegro
                          </option>
                          <option value="Montserrat" %%=IIF(@country=='Montserrat' , "selected" , "" )=%%>Montserrat
                          </option>
                          <option value="Morocco" %%=IIF(@country=='Morocco' , "selected" , "" )=%%>Morocco</option>
                          <option value="Mozambique" %%=IIF(@country=='Mozambique' , "selected" , "" )=%%>Mozambique
                          </option>
                          ...
                          <option value="Nauru" %%=IIF(@country=='Nauru' , "selected" , "" )=%%>
                            Nauru</option>
                          <option value="Nepal" %%=IIF(@country=='Nepal' , "selected" , "" )=%%>
                            Nepal</option>
                          <option value="Netherlands The" %%=IIF(@country=='Netherlands The' , "selected" , "" )=%%>
                            Netherlands The</option>
                          <option value="New Caledonia" %%=IIF(@country=='New Caledonia' , "selected" , "" )=%%>New
                            Caledonia</option>
                          <option value="New Zealand" %%=IIF(@country=='New Zealand' , "selected" , "" )=%%>New Zealand
                          </option>
                          <option value="Nicaragua" %%=IIF(@country=='Nicaragua' , "selected" , "" )=%%>Nicaragua</option>
                          <option value="Niger" %%=IIF(@country=='Niger' , "selected" , "" )=%%>
                            Niger</option>
                          <option value="Nigeria" %%=IIF(@country=='Nigeria' , "selected" , "" )=%%>Nigeria</option>
                          <option value="Niue" %%=IIF(@country=='Niue' , "selected" , "" )=%%>Niue
                          </option>
                          <option value="Norfolk Island" %%=IIF(@country=='Norfolk Island' , "selected" , "" )=%%>Norfolk
                            Island</option>
                          <option value="Northern Mariana Islands" %%=IIF(@country=='Northern Mariana Islands' , "selected"
                            , "" )=%%>
                            Northern Mariana Islands
                          </option>
                          <option value="Norway" %%=IIF(@country=='Norway' , "selected" , "" )=%%>
                            Norway</option>
                          <option value="Oman" %%=IIF(@country=='Oman' , "selected" , "" )=%%>Oman
                          </option>
                          <option value="Pakistan" %%=IIF(@country=='Pakistan' , "selected" , "" )=%%>Pakistan</option>
                          <option value="Palau" %%=IIF(@country=='Palau' , "selected" , "" )=%%>
                            Palau</option>
                          <option value="Palestinian Territory Occupied" %%=IIF(@country=='Palestinian Territory Occupied'
                            , "selected" , "" )=%%>Palestinian Territory
                            Occupied</option>
                          <option value="Panama" %%=IIF(@country=='Panama' , "selected" , "" )=%%>
                            Panama</option>
                          <option value="Papua new Guinea" %%=IIF(@country=='Papua new Guinea' , "selected" , "" )=%%>Papua
                            new Guinea</option>
                          <option value="Paraguay" %%=IIF(@country=='Paraguay' , "selected" , "" )=%%>Paraguay</option>
                          <option value="Peru" %%=IIF(@country=='Peru' , "selected" , "" )=%%>Peru
                          </option>
                          <option value="Philippines" %%=IIF(@country=='Philippines' , "selected" , "" )=%%>Philippines
                          </option>
                          <option value="Pitcairn Island" %%=IIF(@country=='Pitcairn Island' , "selected" , "" )=%%>Pitcairn
                            Island</option>
                          <option value="Poland" %%=IIF(@country=='Poland' , "selected" , "" )=%%>
                            Poland</option>
                          <option value="Portugal" %%=IIF(@country=='Portugal' , "selected" , "" )=%%>Portugal</option>
                          <option value="Puerto Rico" %%=IIF(@country=='Puerto Rico' , "selected" , "" )=%%>Puerto Rico
                          </option>
                          <option value="Qatar" %%=IIF(@country=='Qatar' , "selected" , "" )=%%>
                            Qatar</option>
                          ...
                          <option value="Russia" %%=IIF(@country=='Russia' , "selected" , "" )=%%>
                            Russia</option>
                          <option value="Rwanda" %%=IIF(@country=='Rwanda' , "selected" , "" )=%%>
                            Rwanda</option>
                          <option value="Saint Helena" %%=IIF(@country=='Saint Helena' , "selected" , "" )=%%>Saint Helena
                          </option>
                          <option value="Saint Kitts And Nevis" %%=IIF(@country=='Saint Kitts And Nevis' , "selected" , ""
                            )=%%>
                            Saint Kitts And Nevis</option>
                          <option value="Saint Lucia" %%=IIF(@country=='Saint Lucia' , "selected" , "" )=%%>Saint Lucia
                          </option>
                          <option value="Saint Pierre and Miquelon" %%=IIF(@country=='Saint Pierre and Miquelon'
                            , "selected" , "" )=%%>
                            Saint Pierre and Miquelon
                          </option>
                          <option value="Saint Vincent And The Grenadines"
                            %%=IIF(@country=='Saint Vincent And The Grenadines' , "selected" , "" )=%%>Saint Vincent And The
                            Grenadines</option>
                          <option value="Saint-Barthelemy" %%=IIF(@country=='Saint-Barthelemy' , "selected" , "" )=%%>
                            Saint-Barthelemy</option>
                          <option value="Saint-Martin (French part)" %%=IIF(@country=='Saint-Martin (French part)'
                            , "selected" , "" )=%%>Saint-Martin (French part)
                          </option>
                          <option value="Samoa" %%=IIF(@country=='Samoa' , "selected" , "" )=%%>
                            Samoa</option>
                          <option value="San Marino" %%=IIF(@country=='San Marino' , "selected" , "" )=%%>San Marino
                          </option>
                          <option value="Sao Tome and Principe" %%=IIF(@country=='Sao Tome and Principe' , "selected" , ""
                            )=%%>Sao
                            Tome and Principe</option>
                          <option value="Saudi Arabia" %%=IIF(@country=='Saudi Arabia' , "selected" , "" )=%%>Saudi Arabia
                          </option>
                          <option value="Senegal" %%=IIF(@country=='Senegal' , "selected" , "" )=%%>Senegal</option>
                          <option value="Serbia" %%=IIF(@country=='Serbia' , "selected" , "" )=%%>
                            Serbia</option>
                          <option value="Seychelles" %%=IIF(@country=='Seychelles' , "selected" , "" )=%%>Seychelles
                          </option>
                          <option value="Sierra Leone" %%=IIF(@country=='Sierra Leone' , "selected" , "" )=%%>Sierra Leone
                          </option>
                          <option value="Singapore" %%=IIF(@country=='Singapore' , "selected" , "" )=%%>Singapore</option>
                          <option value="Sint Maarten (Dutch part)" %%=IIF(@country=='Sint Maarten (Dutch part)'
                            , "selected" , "" )=%%>
                          ...
                          <option value="Solomon Islands" %%=IIF(@country=='Solomon Islands' , "selected" , "" )=%%>Solomon
                            Islands</option>
                          <option value="Somalia" %%=IIF(@country=='Somalia' , "selected" , "" )=%%>Somalia</option>
                          <option value="South Africa" %%=IIF(@country=='South Africa' , 'selected' , "" )=%%>South Africa
                          </option>
                          <option value="South Georgia" %%=IIF(@country=='South Georgia' , "selected" , "" )=%%>South
                            Georgia</option>
                          <option value="South Sudan" %%=IIF(@country=='South Sudan' , "selected" , "" )=%%>South Sudan
                          </option>
                          <option value="Spain" %%=IIF(@country=='Spain' , "selected" , "" )=%%>
                            Spain</option>
                          <option value="Sri Lanka" %%=IIF(@country=='Sri Lanka' , "selected" , "" )=%%>Sri Lanka</option>
                          <option value="Sudan" %%=IIF(@country=='Sudan' , "selected" , "" )=%%>
                            Sudan</option>
                          <option value="Suriname" %%=IIF(@country=='Suriname' , "selected" , "" )=%%>Suriname</option>
                          <option value="Svalbard And Jan Mayen Islands" %%=IIF(@country=='Svalbard And Jan Mayen Islands'
                            , "selected" , "" )=%%>Svalbard And Jan Mayen
                            Islands</option>
                          <option value="Swaziland" %%=IIF(@country=='Swaziland' , "selected" , "" )=%%>Swaziland</option>
                          <option value="Sweden" %%=IIF(@country=='Sweden' , "selected" , "" )=%%>
                            Sweden</option>
                          <option value="Switzerland" %%=IIF(@country=='Switzerland' , "selected" , "" )=%%>Switzerland
                          </option>
                          <option value="Syria" %%=IIF(@country=='Syria' , "selected" , "" )=%%>
                            Syria</option>
                          <option value="Taiwan" %%=IIF(@country=='Taiwan' , "selected" , "" )=%%>
                            Taiwan</option>
                          <option value="Tajikistan" %%=IIF(@country=='Tajikistan' , "selected" , "" )=%%>Tajikistan
                          </option>
                          ...
                          <option value="Togo" %%=IIF(@country=='Togo' , "selected" , "" )=%%>Togo
                          </option>
                          <option value="Tokelau" %%=IIF(@country=='Tokelau' , "selected" , "" )=%%>Tokelau</option>
                          <option value="Tonga" %%=IIF(@country=='Tonga' , "selected" , "" )=%%>
                            Tonga</option>
                          <option value="Trinidad And Tobago" %%=IIF(@country=='Trinidad And Tobago' , "selected" , "" )=%%>
                            Trinidad And Tobago</option>
                          <option value="Tunisia" %%=IIF(@country=='Tunisia' , "selected" , "" )=%%>Tunisia</option>
                          <option value="Turkey" %%=IIF(@country=='Turkey' , "selected" , "" )=%%>
                            Turkey</option>
                          <option value="Turkmenistan" %%=IIF(@country=='Turkmenistan' , "selected" , "" )=%%>Turkmenistan
                          </option>
                          <option value="Turks And Caicos Islands" %%=IIF(@country=='Turks And Caicos Islands' , "selected"
                            , "" )=%%>
                            Turks And Caicos Islands
                          </option>
                          <option value="Tuvalu" %%=IIF(@country=='Tuvalu' , "selected" , "" )=%%>
                            Tuvalu</option>
                          <option value="Uganda" %%=IIF(@country=='Uganda' , "selected" , "" )=%%>
                            Uganda</option>
                          <option value="Ukraine" %%=IIF(@country=='Ukraine' , "selected" , "" )=%%>Ukraine</option>
                          <option value="United Arab Emirates" %%=IIF(@country=='United Arab Emirates' , "selected" , ""
                            )=%%>
                            United Arab Emirates</option>
                          <option value="United Kingdom" %%=IIF(@country=='United Kingdom' , "selected" , "" )=%%>United
                            Kingdom</option>
                          <option value="United States" %%=IIF(@country=='United States' , "selected" , "" )=%%>United
                            States</option>
                          <option value="United States Minor Outlying Islands"
                            %%=IIF(@country=='United States Minor Outlying Islands' , "selected" , "" )=%%>United States
                            Minor
                            Outlying Islands</option>
                          <option value="Uruguay" %%=IIF(@country=='Uruguay' , "selected" , "" )=%%>Uruguay</option>
                          <option value="Uzbekistan" %%=IIF(@country=='Uzbekistan' , "selected" , "" )=%%>Uzbekistan
                          </option>
                          <option value="Vanuatu" %%=IIF(@country=='Vanuatu' , "selected" , "" )=%%>Vanuatu</option>
                          <option value="Vatican City State (Holy See)" %%=IIF(@country=='Vatican City State (Holy See)'
                            , "selected" , "" )=%%>Vatican City State (Holy
                            See)</option>
                          ...
                          <option value="Virgin Islands (British)" %%=IIF(@country=='Virgin Islands (British)' , "selected"
                            , "" )=%%>
                            Virgin Islands (British)
                          </option>
                          <option value="Virgin Islands (US)" %%=IIF(@country=='Virgin Islands (US)' , "selected" , "" )=%%>
                            Virgin
                            Islands (US)</option>
                          <option value="Wallis And Futuna Islands" %%=IIF(@country=='Wallis And Futuna Islands'
                            , "selected" , "" )=%%>
                            Wallis And Futuna Islands
                          </option>
                          <option value="Western Sahara" %%=IIF(@country=='Western Sahara' , "selected" , "" )=%%>Western
                            Sahara</option>
                          <option value="Yemen" %%=IIF(@country=='Yemen' , "selected" , "" )=%%>
                            Yemen</option>
                          <option value="Zambia" %%=IIF(@country=='Zambia' , "selected" , "" )=%%>
                            Zambia</option>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="form-group" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
                      <label for="">Nationality (<b>UAE Residents only</b>)
                      </label>
                      <div class="select-wrapper hide-icon">
                        <select class="form-control" name="profileNationality" id="nationality">
                          <option value="">Select Nationality</option>
                          <option value="Afghanistan" %%=IIF(@nationality=='Afghanistan' , "selected" , "" )=%%>Afghanistan
                          </option>
                          <option value="Aland Islands" %%=IIF(@nationality=='Aland Islands' , 'selected' , "" )=%%>Aland
                            Islands</option>
                          ...
                          <option value="American Samoa" %%=IIF(@nationality=='American Samoa' , "selected" , "" )=%%>
                          ...
                          <option value="Antarctica" %%=IIF(@nationality=='Antarctica' , "selected" , "" )=%%>Antarctica
                          </option>
                          <option value="Antigua And Barbuda" %%=IIF(@nationality=='Antigua And Barbuda' , "selected" , ""
                            )=%%>
                            Antigua And Barbuda</option>
                          <option value="Argentina" %%=IIF(@nationality=='Argentina' , "selected" , "" )=%%>Argentina
                          </option>
                          ...
                          <option value="Australia" %%=IIF(@nationality=='Australia' , "selected" , "" )=%%>Australia
                          </option>
                          <option value="Austria" %%=IIF(@nationality=='Austria' , "selected" , "" )=%%>Austria</option>
                          <option value="Azerbaijan" %%=IIF(@nationality=='Azerbaijan' , "selected" , "" )=%%>Azerbaijan
                          </option>
                          <option value="Bahamas The" %%=IIF(@nationality=='Bahamas The' , "selected" , "" )=%%>Bahamas The
                          </option>
                          <option value="Bahrain" %%=IIF(@nationality=='Bahrain' , "selected" , "" )=%%>Bahrain</option>
                          <option value="Bangladesh" %%=IIF(@nationality=='Bangladesh' , "selected" , "" )=%%>Bangladesh
                          </option>
                          ...
                          <option value="Bonaire Sint Eustatius and Saba"
                            %%=IIF(@nationality=="Bonaire Sint Eustatius and Saba" , "selected" , "" )=%%>Bonaire, Sint
                            Eustatius
                            and Saba</option>
                          <option value="Bosnia and Herzegovina" %%=IIF(@nationality=='Bosnia and Herzegovina' , "selected"
                            , "" )=%%>Bosnia and Herzegovina</option>
                          <option value="Botswana" %%=IIF(@nationality=='Botswana' , "selected" , "" )=%%>Botswana</option>
                          <option value="Bouvet Island" %%=IIF(@nationality=='Bouvet Island' , "selected" , "" )=%%>Bouvet
                            Island</option>
                          <option value="Brazil" %%=IIF(@nationality=='Brazil' , "selected" , "" )=%%>Brazil</option>
                          <option value="British Indian Ocean Territory"
                            %%=IIF(@nationality=='British Indian Ocean Territory' , "selected" , "" )=%%>British Indian
                            Ocean
                            Territory</option>
                          ...
                          <option value="Burkina Faso" %%=IIF(@nationality=='Burkina Faso' , "selected" , "" )=%%>Burkina
                            Faso</option>
                          ...
                          <option value="Cape Verde" %%=IIF(@nationality=='Cape Verde' , "selected" , "" )=%%>Cape Verde
                          </option>
                          <option value="Cayman Islands" %%=IIF(@nationality=='Cayman Islands' , "selected" , "" )=%%>Cayman
                            Islands</option>
                          <option value="Central African Republic" %%=IIF(@nationality=='Central African Republic' ,
                            selected, "" )=%%>
                            Central African Republic
                          </option>
                          <option value="Chad" %%=IIF(@nationality=='Chad' , "selected" , "" )=%%>
                            Chad</option>
                          ...
                          <option value="Christmas Island" %%=IIF(@nationality=='Christmas Island' , "selected" , "" )=%%>
                            Christmas Island</option>
                          <option value="Cocos (Keeling) Islands" %%=IIF(@nationality=='Cocos (Keeling) Islands'
                            , "selected" , "" )=%%>Cocos (Keeling) Islands</option>
                          ...
                          <option value="Congo The Democratic Republic Of The"
                            %%=IIF(@nationality=='Congo The Democratic Republic Of The' , "selected" , "" )=%%>Congo The
                            Democratic Republic Of The</option>
                          <option value="Cook Islands" %%=IIF(@nationality=='Cook Islands' , "selected" , "" )=%%>Cook
                            Islands</option>
                          <option value="Costa Rica" %%=IIF(@nationality=='Costa Rica' , "selected" , "" )=%%>Costa Rica
                          </option>
                          <option value="Cote D'Ivoire (Ivory Coast)" %%=IIF(@nationality=="Cote D'Ivoire (Ivory Coast)"
                            , "selected" , "" )=%%>Cote D'Ivoire (Ivory Coast)
                          </option>
                          <option value="Croatia (Hrvatska)" %%=IIF(@nationality=='Croatia (Hrvatska)' , "selected" , ""
                            )=%%>
                            Croatia (Hrvatska)</option>
                          <option value="Cuba" %%=IIF(@nationality=='Cuba' , "selected" , "" )=%%>
                            Cuba</option>
                          ...
                          <option value="Czech Republic" %%=IIF(@nationality=='Czech Republic' , "selected" , "" )=%%>Czech
                            Republic</option>
                          ...
                          <option value="Dominican Republic" %%=IIF(@nationality=='Dominican Republic' , "selected" , ""
                            )=%%>
                            Dominican Republic</option>
                          <option value="East Timor" %%=IIF(@nationality=='East Timor' , "selected" , "" )=%%>East Timor
                          </option>
                          ...
                          <option value="El Salvador" %%=IIF(@nationality=='El Salvador' , "selected" , "" )=%%>El Salvador
                          </option>
                          <option value="Equatorial Guinea" %%=IIF(@nationality=='Equatorial Guinea' , "selected" , "" )=%%>
                            Equatorial Guinea</option>
                          ...
                          <option value="Falkland Islands" %%=IIF(@nationality=='Falkland Islands' , "selected" , "" )=%%>
                            Falkland Islands</option>
                          <option value="Faroe Islands" %%=IIF(@nationality=='Faroe Islands' , "selected" , "" )=%%>Faroe
                            Islands</option>
                          <option value="Fiji Islands" %%=IIF(@nationality=='Fiji Islands' , "selected" , "" )=%%>Fiji
                            Islands</option>
                          ...
                          <option value="French Guiana" %%=IIF(@nationality=='French Guiana' , "selected" , "" )=%%>French
                            Guiana</option>
                          <option value="French Polynesia" %%=IIF(@nationality=='French Polynesia' , "selected" , "" )=%%>
                            French Polynesia</option>
                          <option value="French Southern Territories" %%=IIF(@nationality=='French Southern Territories'
                            , "selected" , "" )=%%>French Southern Territories
                          </option>
                          <option value="Gabon" %%=IIF(@nationality=='Gabon' , "selected" , "" )=%%>Gabon</option>
                          <option value="Gambia The" %%=IIF(@nationality=='Gambia The' , "selected" , "" )=%%>Gambia The
                          </option>
                          ...
                          <option value="Gibraltar" %%=IIF(@nationality=='Gibraltar' , "selected" , "" )=%%>Gibraltar
                          </option>
                          <option value="Greece" %%=IIF(@nationality=='Greece' , "selected" , "" )=%%>Greece</option>
                          <option value="Greenland" %%=IIF(@nationality=='Greenland' , "selected" , "" )=%%>Greenland
                          </option>
                          <option value="Grenada" %%=IIF(@nationality=='Grenada' , "selected" , "" )=%%>Grenada</option>
                          <option value="Guadeloupe" %%=IIF(@nationality=='Guadeloupe' , "selected" , "" )=%%>Guadeloupe
                          </option>
                          <option value="Guam" %%=IIF(@nationality=='Guam' , "selected" , "" )=%%>
                            Guam</option>
                          <option value="Guatemala" %%=IIF(@nationality=='Guatemala' , "selected" , "" )=%%>Guatemala
                          </option>
                          <option value="Guernsey and Alderney" %%=IIF(@nationality=='Guernsey and Alderney' , "selected"
                            , "" )=%%>
                            Guernsey and Alderney</option>
                          <option value="Guinea" %%=IIF(@nationality=='Guinea' , "selected" , "" )=%%>Guinea</option>
                          <option value="Guinea-Bissau" %%=IIF(@nationality=='Guinea-Bissau' , "selected" , "" )=%%>
                            Guinea-Bissau</option>
                          ...
                          <option value="Heard Island and McDonald Islands"
                            %%=IIF(@nationality=='Heard Island and McDonald Islands' , "selected" , "" )=%%>Heard Island and
                            McDonald Islands</option>
                          <option value="Honduras" %%=IIF(@nationality=='Honduras' , "selected" , "" )=%%>Honduras</option>
                          <option value="Hong Kong S.A.R." %%=IIF(@nationality=='Hong Kong S.A.R.' , "selected" , "" )=%%>
                          ...
                          <option value="Indonesia" %%=IIF(@nationality=='Indonesia' , "selected" , "" )=%%>Indonesia
                          </option>
                          <option value="Iran" %%=IIF(@nationality=='Iran' , "selected" , "" )=%%>
                            Iran</option>
                          <option value="Iraq" %%=IIF(@nationality=='Iraq' , "selected" , "" )=%%>
                            Iraq</option>
                          ...
                          <option value="Kazakhstan" %%=IIF(@nationality=='Kazakhstan' , "selected" , "" )=%%>Kazakhstan
                          </option>
                          ...
                          <option value="Korea North" %%=IIF(@nationality=='Korea North' , "selected" , "" )=%%>Korea North
                          </option>
                          <option value="Korea South" %%=IIF(@nationality=='Korea South' , "selected" , "" )=%%>Korea South
                          </option>
                          ...
                          <option value="Kyrgyzstan" %%=IIF(@nationality=='Kyrgyzstan' , "selected" , "" )=%%>Kyrgyzstan
                          </option>
                          <option value="Laos" %%=IIF(@nationality=='Laos' , "selected" , "" )=%%>
                            Laos</option>
                          ...
                          <option value="Liechtenstein" %%=IIF(@nationality=='Liechtenstein' , "selected" , "" )=%%>
                            Liechtenstein</option>
                          <option value="Lithuania" %%=IIF(@nationality=='Lithuania' , "selected" , "" )=%%>Lithuania
                          </option>
                          <option value="Luxembourg" %%=IIF(@nationality=='Luxembourg' , "selected" , "" )=%%>Luxembourg
                          </option>
                          <option value="Macau S.A.R." %%=IIF(@nationality=='Macau S.A.R.' , "selected" , "" )=%%>Macau
                            S.A.R.</option>
                          <option value="Macedonia" %%=IIF(@nationality=='Macedonia' , "selected" , "" )=%%>Macedonia
                          </option>
                          <option value="Madagascar" %%=IIF(@nationality=='Madagascar' , "selected" , "" )=%%>Madagascar
                          </option>
                          ...
                          <option value="Mali" %%=IIF(@nationality=='Mali' , "selected" , "" )=%%>
                            Mali</option>
                          <option value="Malta" %%=IIF(@nationality=='Malta' , "selected" , "" )=%%>Malta</option>
                          <option value="Man (Isle of)" %%=IIF(@nationality=='Man (Isle of)' , "selected" , "" )=%%>Man
                            (Isle of)</option>
                          <option value="Marshall Islands" %%=IIF(@nationality=='Marshall Islands' , "selected" , "" )=%%>
                            Marshall Islands</option>
                          <option value="Martinique" %%=IIF(@nationality=='Martinique' , "selected" , "" )=%%>Martinique
                          </option>
                          <option value="Mauritania" %%=IIF(@nationality=='Mauritania' , "selected" , "" )=%%>Mauritania
                          </option>
                          <option value="Mauritius" %%=IIF(@nationality=='Mauritius' , "selected" , "" )=%%>Mauritius
                          </option>
                          ...
                          <option value="Micronesia" %%=IIF(@nationality=='Micronesia' , "selected" , "" )=%%>Micronesia
                          </option>
                          ...
                          <option value="Montenegro" %%=IIF(@nationality=='Montenegro' , "selected" , "" )=%%>Montenegro
                          </option>
                          <option value="Montserrat" %%=IIF(@nationality=='Montserrat' , "selected" , "" )=%%>Montserrat
                          </option>
                          <option value="Morocco" %%=IIF(@nationality=='Morocco' , "selected" , "" )=%%>Morocco</option>
                          <option value="Mozambique" %%=IIF(@nationality=='Mozambique' , "selected" , "" )=%%>Mozambique
                          </option>
                          ...
                          <option value="Netherlands The" %%=IIF(@nationality=='Netherlands The' , "selected" , "" )=%%>
                            Netherlands The</option>
                          <option value="New Caledonia" %%=IIF(@nationality=='New Caledonia' , "selected" , "" )=%%>New
                            Caledonia</option>
                          <option value="New Zealand" %%=IIF(@nationality=='New Zealand' , "selected" , "" )=%%>New Zealand
                          </option>
                          <option value="Nicaragua" %%=IIF(@nationality=='Nicaragua' , "selected" , "" )=%%>Nicaragua
                          </option>
                          ...
                          <option value="Niue" %%=IIF(@nationality=='Niue' , "selected" , "" )=%%>
                            Niue</option>
                          <option value="Norfolk Island" %%=IIF(@nationality=='Norfolk Island' , "selected" , "" )=%%>
                            Norfolk Island</option>
                          <option value="Northern Mariana Islands" %%=IIF(@nationality=='Northern Mariana Islands'
                            , "selected" , "" )=%%>Northern Mariana Islands
                          </option>
                          <option value="Norway" %%=IIF(@nationality=='Norway' , "selected" , "" )=%%>Norway</option>
                          <option value="Oman" %%=IIF(@nationality=='Oman' , "selected" , "" )=%%>
                            Oman</option>
                          ...
                          <option value="Palestinian Territory Occupied"
                            %%=IIF(@nationality=='Palestinian Territory Occupied' , "selected" , "" )=%%>Palestinian
                            Territory
                            Occupied</option>
                          <option value="Panama" %%=IIF(@nationality=='Panama' , "selected" , "" )=%%>Panama</option>
                          <option value="Papua new Guinea" %%=IIF(@nationality=='Papua new Guinea' , "selected" , "" )=%%>
                            Papua new Guinea</option>
                          <option value="Paraguay" %%=IIF(@nationality=='Paraguay' , "selected" , "" )=%%>Paraguay</option>
                          <option value="Peru" %%=IIF(@nationality=='Peru' , "selected" , "" )=%%>
                            Peru</option>
                          <option value="Philippines" %%=IIF(@nationality=='Philippines' , "selected" , "" )=%%>Philippines
                          </option>
                          <option value="Pitcairn Island" %%=IIF(@nationality=='Pitcairn Island' , "selected" , "" )=%%>
                          ...
                          <option value="Puerto Rico" %%=IIF(@nationality=='Puerto Rico' , "selected" , "" )=%%>Puerto Rico
                          </option>
                          ...
                          <option value="Saint Helena" %%=IIF(@nationality=='Saint Helena' , "selected" , "" )=%%>Saint
                            Helena</option>
                          <option value="Saint Kitts And Nevis" %%=IIF(@nationality=='Saint Kitts And Nevis' , "selected"
                            , "" )=%%>
                            Saint Kitts And Nevis</option>
                          <option value="Saint Lucia" %%=IIF(@nationality=='Saint Lucia' , "selected" , "" )=%%>Saint Lucia
                          </option>
                          <option value="Saint Pierre and Miquelon" %%=IIF(@nationality=='Saint Pierre and Miquelon'
                            , "selected" , "" )=%%>Saint Pierre and Miquelon
                          </option>
                          <option value="Saint Vincent And The Grenadines"
                            %%=IIF(@nationality=='Saint Vincent And The Grenadines' , "selected" , "" )=%%>Saint Vincent And
                            The
                            Grenadines</option>
                          <option value="Saint-Barthelemy" %%=IIF(@nationality=='Saint-Barthelemy' , "selected" , "" )=%%>
                            Saint-Barthelemy</option>
                          <option value="Saint-Martin (French part)" %%=IIF(@nationality=='Saint-Martin (French part)'
                            , "selected" , "" )=%%>Saint-Martin (French part)
                          </option>
                          <option value="Samoa" %%=IIF(@nationality=='Samoa' , "selected" , "" )=%%>Samoa</option>
                          <option value="San Marino" %%=IIF(@nationality=='San Marino' , "selected" , "" )=%%>San Marino
                          </option>
                          <option value="Sao Tome and Principe" %%=IIF(@nationality=='Sao Tome and Principe' , "selected"
                            , "" )=%%>
                            Sao Tome and Principe</option>
                          <option value="Saudi Arabia" %%=IIF(@nationality=='Saudi Arabia' , "selected" , "" )=%%>Saudi
                            Arabia</option>
                          ...
                          <option value="Seychelles" %%=IIF(@nationality=='Seychelles' , "selected" , "" )=%%>Seychelles
                          </option>
                          <option value="Sierra Leone" %%=IIF(@nationality=='Sierra Leone' , "selected" , "" )=%%>Sierra
                            Leone</option>
                          <option value="Singapore" %%=IIF(@nationality=='Singapore' , "selected" , "" )=%%>Singapore
                          </option>
                          <option value="Sint Maarten (Dutch part)" %%=IIF(@nationality=='Sint Maarten (Dutch part)'
                            , "selected" , "" )=%%>Sint Maarten (Dutch part)
                          </option>
                          ...
                          <option value="Solomon Islands" %%=IIF(@nationality=='Solomon Islands' , "selected" , "" )=%%>
                            Solomon Islands</option>
                          <option value="Somalia" %%=IIF(@nationality=='Somalia' , "selected" , "" )=%%>Somalia</option>
                          <option value="South Africa" %%=IIF(@nationality=='South Africa' , 'selected' , "" )=%%>South
                            Africa</option>
                          <option value="South Georgia" %%=IIF(@nationality=='South Georgia' , "selected" , "" )=%%>South
                            Georgia</option>
                          <option value="South Sudan" %%=IIF(@nationality=='South Sudan' , "selected" , "" )=%%>South Sudan
                          </option>
                          <option value="Spain" %%=IIF(@nationality=='Spain' , "selected" , "" )=%%>Spain</option>
                          <option value="Sri Lanka" %%=IIF(@nationality=='Sri Lanka' , "selected" , "" )=%%>Sri Lanka
                          </option>
                          ...
                          <option value="Svalbard And Jan Mayen Islands"
                            %%=IIF(@nationality=='Svalbard And Jan Mayen Islands' , "selected" , "" )=%%>Svalbard And Jan
                            Mayen
                            Islands</option>
                          <option value="Swaziland" %%=IIF(@nationality=='Swaziland' , "selected" , "" )=%%>Swaziland
                          </option>
                          <option value="Sweden" %%=IIF(@nationality=='Sweden' , "selected" , "" )=%%>Sweden</option>
                          <option value="Switzerland" %%=IIF(@nationality=='Switzerland' , "selected" , "" )=%%>Switzerland
                          </option>
                          ...
                          <option value="Tajikistan" %%=IIF(@nationality=='Tajikistan' , "selected" , "" )=%%>Tajikistan
                          </option>
                          ...
                          <option value="Togo" %%=IIF(@nationality=='Togo' , "selected" , "" )=%%>
                            Togo</option>
                          ...
                          <option value="Trinidad And Tobago" %%=IIF(@nationality=='Trinidad And Tobago' , "selected" , ""
                            )=%%>
                            Trinidad And Tobago</option>
                          ...
                          <option value="Turkmenistan" %%=IIF(@nationality=='Turkmenistan' , "selected" , "" )=%%>
                            Turkmenistan</option>
                          <option value="Turks And Caicos Islands" %%=IIF(@nationality=='Turks And Caicos Islands'
                            , "selected" , "" )=%%>Turks And Caicos Islands
                          </option>
                          ...
                          <option value="United Arab Emirates" %%=IIF(@nationality=='United Arab Emirates' , "selected" , ""
                            )=%%>
                            United Arab Emirates</option>
                          <option value="United Kingdom" %%=IIF(@nationality=='United Kingdom' , "selected" , "" )=%%>United
                            Kingdom</option>
                          <option value="United States" %%=IIF(@nationality=='United States' , "selected" , "" )=%%>United
                            States</option>
                          <option value="United States Minor Outlying Islands"
                            %%=IIF(@nationality=='United States Minor Outlying Islands' , "selected" , "" )=%%>United States
                            Minor
                            Outlying Islands</option>
                          <option value="Uruguay" %%=IIF(@nationality=='Uruguay' , "selected" , "" )=%%>Uruguay</option>
                          <option value="Uzbekistan" %%=IIF(@nationality=='Uzbekistan' , "selected" , "" )=%%>Uzbekistan
                          </option>
                          <option value="Vanuatu" %%=IIF(@nationality=='Vanuatu' , "selected" , "" )=%%>Vanuatu</option>
                          <option value="Vatican City State (Holy See)" %%=IIF(@nationality=='Vatican City State (Holy See)'
                            , "selected" , "" )=%%>Vatican City State (Holy
                            See)</option>
                          <option value="Venezuela" %%=IIF(@nationality=='Venezuela' , "selected" , "" )=%%>Venezuela
                          </option>
                          <option value="Vietnam" %%=IIF(@nationality=='Vietnam' , "selected" , "" )=%%>Vietnam</option>
                          <option value="Virgin Islands (British)" %%=IIF(@nationality=='Virgin Islands (British)'
                            , "selected" , "" )=%%>Virgin Islands (British)
                          </option>
                          <option value="Virgin Islands (US)" %%=IIF(@nationality=='Virgin Islands (US)' , "selected" , ""
                            )=%%>
                            Virgin Islands (US)</option>
                          <option value="Wallis And Futuna Islands" %%=IIF(@nationality=='Wallis And Futuna Islands'
                            , "selected" , "" )=%%>Wallis And Futuna Islands
                          </option>
                          <option value="Western Sahara" %%=IIF(@nationality=='Western Sahara' , "selected" , "" )=%%>
    ...
    <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-12 bdate">
    ...
    placeholder="" class="form-control">
                ...
                <h4 class="pt-4 pb-4">Tell us a bit more about your family
                </h4>
                  ...
                  <div class="radio-wrapper">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1"
                        value="option1" %%=IIF(@marriedStatus=='Single' , 'checked' , '' )=%%>
                      <label class="form-check-label" for="inlineRadio1">Single</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2"
                        value="option2" %%=IIF(@marriedStatus=='Married' , 'checked' , '' )=%%>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="form-group">
                          ...
                          <div class="select-wrapper">
                            <select class="form-control selectpicker" name="state" id="numOfKids"
                              onclick="kidsPrepopulation();">
                              <option value="0" %%=IIF(@numOfKids==0, "selected" , "" )=%%>Select
                              </option>
                              <option value="1" %%=IIF(@numOfKids==1, "selected" , "" )=%%>1
                              </option>
                              <option value="2" %%=IIF(@numOfKids==2, "selected" , "" )=%%>2
                              </option>
                              <option value="3" %%=IIF(@numOfKids==3, "selected" , "" )=%%>3
                              </option>
                              <option value="4" %%=IIF(@numOfKids==4, "selected" , "" )=%%>4
                              </option>
                              <option value="5" %%=IIF(@numOfKids==5, "selected" , "" )=%%>5
                              </option>
                              <option value="6" %%=IIF(@numOfKids==6, "selected" , "" )=%%>6
                              </option>
                              <option value="7" %%=IIF(@numOfKids==7, "selected" , "" )=%%>7
                              </option>
                              <option value="8" %%=IIF(@numOfKids==8, "selected" , "" )=%%>8
                              </option>
                              <option value="9" %%=IIF(@numOfKids==9, "selected" , "" )=%%>9
                              </option>
                              <option value="10" %%=IIF(@numOfKids==10, "selected" , "" )=%%>10
                              </option>
                            </select>
                          </div>
                        </div>
    ...
    SET @bfContactRows =RetrieveSalesforceObjects("Contact",
      "Id,Salutation,FirstName,LastName,Email,Phone,Country_Code__c,Birthdate,Registration_Language__c,Nationality__c,Marital_Status__c,Residence_Country__c,No_of_Kids__c,GenderIdentity,MailingCity,Do_you_have_kids__c,GV_ContactId__c",
        ...
        set @crmId = Field(@contactRow, "Id")
                ...
                SET @childDetails =
                RetrieveSalesforceObjects("Family_Member__c","Gender__c,Date_Of_Birth__c,First_Name__c,ID,Last_Name__c,Deleted_kid__c",
                "Contact__c", "=", @crmId,
                "Relationship__c", "=", "Child")
                ...
                /*IF @childGender ==" " OR @childGender =="" THEN
                SET @childGender = "Select"
                Output(concat("childGender: ",@childGender))
                ENDIF*/
                ...
                <input type="hidden" id="kidName%%=v(@count)=%%" name="kidName%%=v(@count)=%%"
                  value="%%=v(@childFullName)=%%">
                <input type="hidden" id="kidDOB%%=v(@count)=%%" name="kidDOB%%=v(@count)=%%" value="%%=v(@childDOB)=%%">
                <input type="hidden" id="kidGen%%=v(@count)=%%" name="kidGen%%=v(@count)=%%"
                  value="%%=v(ProperCase(@childGender))=%%">
                <input type="hidden" id="kidRecId%%=v(@count)=%%" name="kidRecId%%=v(@count)=%%"
                  value="%%=v(@childRecID)=%%">
                <input type="hidden" id="deletedKid%%=v(@count)=%%" name="deletedKid%%=v(@count)=%%"
                  value="%%=v(@childRecID)=%%">
                %%[
                ENDIF
                next @j
              ...
              SET @profileCity = RequestParameter("City")
              /*SET @monthlySpend = RequestParameter("priceRange")*/
              ...
              IF Empty(@gender) THEN
              SET @updateRecord = UpdateSingleSalesforceObject(
              "Contact", @sfid,
              "fieldsToNull", "GenderIdentity"
              )
              ELSE
              SET @updateRecord = UpdateSingleSalesforceObject(
              "Contact", @sfid,
              ...
              ENDIF
              IF Empty(@doYouHaveKids) THEN
              SET @updateRecord = UpdateSingleSalesforceObject(
              "Contact", @sfid,
              "fieldsToNull", "Do_you_have_kids__c"
              )
              ELSE
              SET @updateRecord = UpdateSingleSalesforceObject(
              "Contact", @sfid,
              ...
              ENDIF
              /*Redirect(Concat("https://cloud.explore.motiongatedubai.com/Motiongate_CPC_QA_Updated?sfid=",Base64Encode(@sfid),"#interests"))*/
             ...
             set @interests = '#interests'
                                       ...
                                       if @methodType== 'Old' then
                                          Redirect(Concat("https://cloud.explore.motiongatedubai.com/MGQA_CPC?sfid=", Base64Encode(@sfid), "#interests"))
                                       ELSE
                                          Redirect(CONCAT(CloudPagesURL(2556),@interests))
                                       ENDIF
          ...
          <!-- 2nd card Interest tab-->
             ...
             <!-- Nitik 4th Mar24, multipicklist Change -->
          ...
          <div class="tab-pane fade interest-tab-content" id="interests" role="tabpanel" aria-labelledby="interests-tab">
            <div class="wrapper wrapper--w700">
              <form class="interest-form" action="%%=RequestParameter('PAGEURL')=%%" method="post" name=""
                id="interest-form" autocomplete="off"
                onsubmit="return validateForm1() && validateForm2() && validateForm3() && moveToTab(3)">
                <div class="form-group">
                  <h4 class="pt-4 pb-3">What is the primary reason for your visit to MOTIONGATE™ Dubai?
                  </h4>
                  <div class="radio-wrapper primary-reason radio-width">
                    ...
                    <div class="form-check form-check">
                      ...
                      <input class="form-check-input" type="checkbox" name="reason3" id="reason3"
                       %%=v(@I_love_rides_and_theme_park)=%% >
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="reason4">I want to celebrate my
                        birthday</label>
                      <input class="form-check-input" type="checkbox" name="reason4" id="reason4"
                        %%=v(@I_want_to_celebrate_birthday)=%% >
                    </div>
                    <div class="form-check form-check">
                      <label class="form-check-label" for="reason5">I am a regular (Annual Pass
                        member)</label>
                      <input class="form-check-input" type="checkbox" name="reason5" id="reason5"
                        %%=v(@AnnualPass)=%%>
                    </div>
                  </div>
                  <h4 class="pt-4 pb-3">How often do you visit MOTIONGATE™ Dubai?</h4>
                  ...
                  <h4 class="pt-4 pb-3">What do you like the most about MOTIONGATE™ Dubai?
                  </h4>
     ...
     %%=v(@hotelsAndResorts)=%%  >
                ...
                <input name="guestId" type="hidden" value="%%=v(@Id)=%%">
                  <input name="emails" type="hidden" value="%%=v(@email)=%%">
                <br>
                <!-- <input name="email" type="hidden" value="%%=v(@email)=%%"><br> -->
                <div class="text-end">
            ...
            SET @emailContact = RequestParameter("emails")
            /* Nitik 4th Mar24, multipicklist changes */
            
            /*SET @primaryReasonToVisitValue = RequestParameter("reason")*/
            SET @oftenVisitValue = RequestParameter("visit")
            /*output(concat("<br>oftenVisitValue: ",@oftenVisitValue))
            SET @likeAboutParkValue = RequestParameter("like")*/
            SET @primaryReasonToVisitValue = CONCAT(
             ...
             if not Empty(@primaryReasonToVisitValue) then
              SET @updateRecord = UpdateSingleSalesforceObject(
                  ...
                  "What_Is_primary_reason_for_your_visit__c", @primaryReasonToVisitValue)
              else
                SET @updateRecord = UpdateSingleSalesforceObject(
                  "Guest_Subscription__c", @guestId,
           ...
           /*output(concat("<br>primaryReasonToVisitValue: ",@primaryReasonToVisitValue))*/
            ...
            /*IF @primaryReasonToVisitValue == 'Fun family activities' THEN
            SET @primaryReasonToVisitUpdation = 'Fun family activities'
            ELSEIF @primaryReasonToVisitValue == 'Its on my Dubai bucket list' THEN
            SET @primaryReasonToVisitUpdation = 'Its on my Dubai bucket list'
            ELSEIF @primaryReasonToVisitValue == 'I love rides and theme parks' THEN
            SET @primaryReasonToVisitUpdation = 'I love rides and theme parks'
            ELSEIF @primaryReasonToVisitValue == 'I want to celebrate my birthday' THEN
            SET @primaryReasonToVisitUpdation = 'I want to celebrate my birthday'
            ELSEIF @primaryReasonToVisitValue == 'I am a regular (Annual Pass member)' THEN
            SET @primaryReasonToVisitUpdation = 'I am a regular (Annual Pass member)'
            ENDIF*/
            ...
            ENDIF
            /*IF @likeAboutParkValue == 'the rides' THEN
            SET @likeAboutParkUpdation = 'the rides'
            ELSEIF @likeAboutParkValue == 'live entertainment' THEN
            SET @likeAboutParkUpdation = 'live entertainment'
            ELSEIF @likeAboutParkValue == 'food and restaurants' THEN
            SET @likeAboutParkUpdation = 'food and restaurants'
            ELSEIF @likeAboutParkValue == 'free events' THEN
            SET @likeAboutParkUpdation = 'free events'
            ELSEIF @likeAboutParkValue == 'hotels and resorts' THEN
            SET @likeAboutParkUpdation = 'hotels and resorts'
            ENDIF*/
            IF NOT Empty(@sfid) THEN
           ...
           if empty(@sfid) OR IsNull(@sfid) then
                                       ...
                                       if @methodType== 'Old' then
                                          Redirect(Concat("https://cloud.explore.motiongatedubai.com/MGQA_CPC?sfid=", Base64Encode(@sfid), "#communications"))
                                       ELSE
                                          Redirect(CONCAT(CloudPagesURL(2556),@communications))
                                       ENDIF
          ...
          <div class="tab-pane fade preferences-tab-content" id="communications" role="tabpanel"
            aria-labelledby="communications-tab">
            <div class="wrapper wrapper--w700">
              <form class="preferences-form" action="" method="post" id="preferences-form">
                <!-- Second -->
                <div class="hear-about">
                  <h4 class="pt-4 pb-3">What would you like to hear about?
                  </h4>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="%%=v(@offersAndPromotions)=%%" id="informCheck11"
                      name="hearOffers" %%=IIF(@offersAndPromotions=='True' ,'checked', "" )=%%>
                    <label class="form-check-label" for="informCheck11">
                      Offers and Promotions
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="%%=v(@upcomingEventsAndFamilies)=%%"
                      id="informCheck12" name="hearEvents" %%=IIF(@upcomingEventsAndFamilies=='True' ,'checked', "" )=%%>
                    <label class="form-check-label" for="informCheck12">
                      Upcoming events for families
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="%%=v(@newRidesAndEntertainement)=%%"
                      id="informCheck13" name="newRides" %%=IIF(@newRidesAndEntertainement=='True' ,'checked', "" )=%%>
                    <label class="form-check-label" for="informCheck13">
                      New rides and entertainment
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="%%=v(@newFoodAndRestaurants)=%%"
                      id="informCheck14" name="newFood" %%=IIF(@newFoodAndRestaurants=='True' ,'checked', "" )=%%>
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="%%=v(@hotelsNdResorts)=%%" id="informCheck15"
                      name="hotelsResorts" %%=IIF(@hotelsNdResorts=='True' ,'checked', "" )=%%>
                    <label class="form-check-label" for="informCheck15">
                      Hotels and resorts
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="%%=v(@customerSurvey)=%%" id="informCheck16"
                      name="cutomerSurvey" %%=IIF(@customerSurvey=='True' ,'checked', "" )=%%>
             ...
             /* Redirect(Concat("https://cloud.explore.motiongatedubai.com/mg_thankyou_qa?sfid=",Base64Encode(@sfid)))*/
             ...
             set @thankYouPage = '#ThankYou'
                                   ...
                                   if @methodType== 'Old' then
                                          Redirect(Concat("https://cloud.explore.motiongatedubai.com/ThankYou_MG_QA?sfid=", Base64Encode(@sfid), "#ThankYou"))
                                   ELSE
                                          Redirect(CONCAT(CloudPagesURL(2557),@thankYouPage))
                                  ENDIF
            ...
            <div class="container">
              <div class="unsubscribe-wrapper form group">
                <div class="thanYou-img mb-2">
                  <img src="https://image.explore.motiongatedubai.com/lib/fe39117373640479751474/m/1/cc4e4cd1-c7cc-4bbc-9af7-a8cbdf762251.png" alt="" class="banner-bg-img">
                </div>
          ...
          <!-- channel preference block end -->
              ...
              <div class="mt-5 pl-2" style="font-size: 16px;">
                <p>To manage SMS subscriptions, please refer to the opt-out feature from the latest SMS message. If you wish to unsubscribe from all MOTIONGATE™ Dubai communications please click on ‘Unsubscribe’.
                </p>
              </div>
    ...
    <input name="crmId" type="hidden" value=""> -->
              ...
              <div class="box-form mt-5" id="unsubscribe-reason">
                <form class="comment-form" action="%%=RequestParameter('PAGEURL')=%%" method="post">
                  ...
                  <div class="container">
                    <div class="unsubscribe-wrapper form group">
                      <div class="thanYou-img mb-2">
                        <img
                          src="https://image.explore.motiongatedubai.com/lib/fe39117373640479751474/m/1/cc4e4cd1-c7cc-4bbc-9af7-a8cbdf762251.png"
                          alt="" class="banner-bg-img">
                      </div>
                      <div class="thankYou-text">
    
                        <p style="font-size:16px; line-height:18px; color:#000000; font-weight: bold;">You’ve been
                  ...
                  <p style="font-size: 18px;">Please help us get better by telling us why you're unsubscribing:
                  </p>
                  <div class="form-check mb-2">
                    <input class="form-check-input" type="checkbox" id="chck1" value="False" name="unsubFreq"
                      %%=IIF(@emailsTooFrequent=='True' ,'checked', "" )=%%>
                    <label class="form-check-label" for="chck1">Emails are too frequent</label>
                  </div>
                  <div class="form-check mb-2">
                    <input class="form-check-input" type="checkbox" id="chck2" value="False" name="unsubRelevance"
                      %%=IIF(@contentIsNotRelevant=='True' ,'checked', "" )=%%>
                    <label class="form-check-label" for="chck2">Content isn't relevant</label>
                  </div>
                  <div class="form-check mb-2">
                    <input class="form-check-input" type="checkbox" id="chck3" value="False" name="unsubNoDubai"
                      %%=IIF(@noLongerInDubai=='True' ,'checked', "" )=%%>
                    <label class="form-check-label" for="chck3">I'm no longer in Dubai</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="chck4" value="False" name="unsubTemp"
                      %%=IIF(@tempPause=='True' ,'checked', "" )=%%>
                    <label class="form-check-label" for="chck4">Temporary Pause (30 Days)</label>
                  </div>
                  <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" id="myCheck1" value="False" onclick="addbox1()"
                      name="unsubOther" %%=IIF(@otherSpecify=='True' ,'checked', "" )=%%>
                    <label class="form-check-label" for="myCheck1">Other (Please specify)</label>
                  </div>
                  <textarea name="nameReason" rows="6" cols="80" id="area1" class="form-control mt-3"
                    value="%%=v(@reasonForUnsub)=%%" placeholder="Tell us more">%%=v(@reasonForUnsub)=%%</textarea>
                  <div class="com-btn mt-5">
                ...
                %%[
                  ...
                  IF RequestParameter("submittedUnsub")==true then
                      ...
                      set @plusTenHour = DateAdd(@currentDate, 10, "H")*/
                      /*Output(concat("<br>plusTenHour: ",@plusTenHour))*/
                      ...
                      IF NOT Empty(@sfid) THEN
                        ...
                        SET @s = upsertData("ENT.TempPauseHandle_QA", 1, "SubscriberKey", @guestId, "Email",
                                              @emailContact,"DateAdded",@currentDate,"ContactId",@sfid, "UnsubscribeType","Individual","Asset","MG")
                      ENDIF
              ...
              <div class="mt-5 pl-2" style="font-size: 16px;">
                <p>If you wish to unsubscribe from all Dubai Holding Entertainment communications which include Dubai Parks™ and Resorts, Roxy Cinemas, The Green Planet™, MOTIONGATE™ Dubai, Global Village Dubai, LEGOLAND® Dubai and Real Madrid World, please click on ‘Unsubscribe all’.
                </p>
              </div>
              <div class="unsrb-all-btn mt-5">
                <button type="button" name="button" class="btn btn-orange unsubscribe-all-btn"
                  onclick="unsubscribeAllClick()" id = "unsubscribeAllClick">Unsubscribe All</button>
              </div>
              <!-- <input name="submittedCommunications" type="hidden" value="true">
    <input name="crmId" type="hidden" value=""> -->
              ...
              <div class="box-form mt-5" id="unsubscribe-all-reason">
                <form class="comment-form" action="%%=RequestParameter('PAGEURL')=%%" method="post">
                  ...
                  <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" id="myCheck_1" value="False" onclick="addbox_1()"
                      name="unsubOther" %%=IIF(@otherSpecify =='True' ,'checked', "" )=%%>
                    <label class="form-check-label" for="myCheck_1">Other (Please specify)</label>
                  </div>
                  <textarea name="nameReason" rows="6" cols="80" id="area_1" class="form-control mt-3" value="%%=v(@reasonForUnsub)=%%"
                    placeholder="Tell us more">%%=v(@reasonForUnsub)=%%</textarea>
                  <div class="com-btn mt-5">
              ...
              %%[
                                    ...
                                    IF NOT Empty(@unsubTempBox) THEN
                                       /* Subscribe from all guest subscriptions */
                                        ...
                                        SET @s = upsertData("ENT.TempPauseHandle_QA", 1, "SubscriberKey", @guestId, "Email", @emailContact,"DateAdded",@currentDate,"ContactId",@sfid,"UnsubscribeType","All","Asset","MG")
     ...
     <footer>
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-12 custom-height">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                  <p><a alias="PrivacyPloicy" href="https://www.dubaiparksandresorts.com/en/dpr-privacy-policy" target="_blank">Privacy Policy</a></p>
                              </div>
                              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-12 col-12 custom-height">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                                ...
                                <ul class="social-media-ul">
                                    <li><a alias="fb" conversion="false" data-linkto="https://" href="https://www.facebook.com/MOTIONGATEDubai" target="_blank" title=""><img alt="" data-assetid="" src="https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/90185405-937c-4d2f-b4ce-2fb03eea25af.png"></a>
                                    </li>
                                    <li> <a alias="Insta" conversion="false" data-linkto="https://" href="https://www.instagram.com/motiongatedubai/" target="_blank" title=""><img alt="" data-assetid="" src="https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/63c4ca71-5917-4a09-a0b5-b19cddb9a796.png"></a>
    
                                    </li>
                                    <li> <a alias="Tiktok" conversion="false" data-linkto="https://" href="https://www.tiktok.com/@motiongate_dubai" target="_blank" title=""><img alt="" data-assetid="92835" src="https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/68336ff0-6304-4b6b-ab54-4191ce055806.png"></a>
    
                                    </li>
                                    <li class="youtube"> <a alias="Youtube" conversion="false" data-linkto="https://" href="https://www.youtube.com/@Motiongatedubai" target="_blank" title=""><img alt="" data-assetid="" src="https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/834b098b-afd8-41eb-bfe1-2e6faadc1fdf.png" ></a>
                                    </li>
      ...
      <!-- footer End -->
      <!-- Vendor JS-->
      <script src="https://cloud.explore.motiongatedubai.com/bootstrap.bundle.min_qa"></script>
      <script src="https://cloud.explore.motiongatedubai.com/select2.min.js_qa"></script>
      <script src="https://cloud.explore.motiongatedubai.com/moment.min_qa"></script>
      <script src="https://cloud.explore.motiongatedubai.com/daterangepicker.js_qa"></script>
      <!-- Main JS-->
      <!--  <script src="https://cloud.explore.globalvillage.ae/custom_mg_dev"></script>-->
      <script src="https://cloud.explore.motiongatedubai.com/custom.js"></script>
    
      <script src="https://cloud.explore.motiongatedubai.com/global_Qa"></script>
      <script>
    ...
    <input type="text" id="kidsName${i}" name="kidsName${i}" value="" class="form-control nameKids" />
      </div>
      </div>
    <div class="col-lg-3 col-md-3 col-sm-12 col-12">
    <div class="form-group">
    ...
    `);
      ...
      <script>
        ...
        function kidsDeletion(param) {
          ...
          $.ajax({
            url: 'https://cloud.explore.motiongatedubai.com/MG_KidsDelete', // Replace with production CloudPage URL
            method: 'POST',
            data: dataToSend,
  ...
  /* if( emailPref.checked !='undefined'){
      ...
      console.log('whatsAppPref: ',whatsAppPref);
              ...
              $.ajax({
                  url: 'https://cloud.explore.motiongatedubai.com/MG_QA_ChannelPreference', // Replace with your CloudPage URL
        ...
        $("#unsubscribeClick").click(function (e) {
          ...
          $.ajax({
            url: 'https://cloud.explore.motiongatedubai.com/bu_unsub_mg', // Replace with your CloudPage URL
            method: 'POST',
            data: dataToSend,
            success: function (response) {
              console.log('SFMC Code Resource called successfully.');
        ...
        $("#unsubscribeAllClick").click(function (e) {
          ...
          $.ajax({
            url: 'https://cloud.explore.motiongatedubai.com/unsubAll', // Replace with your CloudPage URL
            method: 'POST',
            data: dataToSend,
            success: function (response) {
              console.log('SFMC Code Resource called successfully.');
