...
SET @bfContactRows =RetrieveSalesforceObjects("Contact",
  "Id,Salutation,FirstName,LastName,Email,Phone,Country_Code__c,Birthdate,Registration_Language__c,Nationality__c,Marital_Status__c,Residence_Country__c,No_of_Kids__c,GenderIdentity,MailingCity,Do_you_have_kids__c,GV_ContactId__c",
   ...
   ENDIF
    ...
    Other_Please_specify__c,Reason_of_Unsubscribe__c,Status__c,Email__c,WhatsApp__c,SMS__c",
...
<!DOCTYPE html>
 ...
 <link rel="icon" type="image/x-icon" href="https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/7a114a43-1bec-400c-8b8d-6b527f658a77.png">
                                <link href='https://cloud.explore.dubaiparksandresorts.com/bootstrap.min_dpr_qa' rel='stylesheet'>
                                
                                <script type='text/javascript' src='https://cloud.explore.dubaiparksandresorts.com/jqueryV2.min_dpr_qa'></script>
                                <link href="https://cloud.explore.dubaiparksandresorts.com/material-design-iconic-font.min_dpr_qa" rel="stylesheet" media="all">
                                <link href="https://cloud.explore.dubaiparksandresorts.com/font-awesome.min_dpr_qa" rel="stylesheet" media="all">
                                <!-- Font special for pages-->
                                <link href="https://fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
                                <link href="https://cloud.explore.dubaiparksandresorts.com/style_dpr_qa" rel="stylesheet">
                                
                              
                                <link href="https://cloud.explore.dubaiparksandresorts.com/font_dpr_qa">
                                <!-- Vendor CSS-->
                                <link href="https://cloud.explore.dubaiparksandresorts.com/select2.min_dpr_qa" rel="stylesheet" media="all">
                                <link href="https://cloud.explore.dubaiparksandresorts.com/daterangepicker_dpr_qa" rel="stylesheet" media="all">
                                <style>
/* nav */
.card {
  max-width: 90rem;
  ...
  Platform.Response.SetResponseHeader("Content-Security-Policy","script-src 'self' 'unsafe-inline' https://image.explore.dubaiparksandresorts.com https://cloud.explore.globalvillage.ae; frame-ancestors 'none'");
        ...
        <header>
          <div class="container">
              <div class="row align-items-center" style="margin: 0 auto;">
                  <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                      <a href="https://www.dubaiparksandresorts.com/en" class="logo-link" target="_blank">
                          <img src="https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/7a31d355-5613-480a-b17d-2c4f26d09d14.png"
                              alt="logo">
                      </a>
                  </div>
                  ...
                  <a href="https://dubaiholding.com/en/who-we-are/our-companies/dubai-holding-entertainment/" class="logo-link" target="_blank">
                      <img src="https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/85184be3-e367-44e6-8edd-153b51ded1c5.png"
            ...
            <a href="https://cloud.explore.dubaiparksandresorts.com/cpc_dpr_ar_qa" class="language-toggle-link" id="langSwitcher" onclick="dynamicLangSwitcher();">العربية</a>
          </div>
      </header>
      <!-- Header End --><section class="banner">
                                  <div class="main-banner">
                                    <img src= "https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/6f6915d8-cb81-4b35-abd7-7140c9aa0b3d.png" alt="banner-img" class="responsive" id="desktop-img">
                                     <img src= "https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/fc63aa03-1afd-4f6b-aea5-7e8097004c47.png" alt="banner-img" class="responsive" id="mob-img">
                                        </div>
                                        <div class="container">
         ...
         var @sfid
                                IF RequestParameter("submittedProfile")==true then
                                   ...
                                   if @methodType== 'Old' then
                                      Redirect(Concat("https://cloud.explore.dubaiparksandresorts.com/DPRQA_CPC?sfid=", Base64Encode(@sfid), "#interests"))
                                   ELSE
                                      Redirect(CONCAT(CloudPagesURL(2431),@interests))
                                   ENDIF
        ...
        <div class="tab-pane fade interest-tab-content" id="interests" role="tabpanel" aria-labelledby="interests-tab">
            ...
            <div class="wrapper wrapper--w700">
              ...
              <form class="interest-form" action="" method="post" name="myForm" id="interest-form" autocomplete="off" >
                  ...
                  <div class="form-group">
                    <h4 class="pt-4 pb-3">What is the primary reason for your visit to Dubai Parks&trade; and Resorts?</h4>
                  ...
                  <input class="form-check-input" type="checkbox" name="reason2" id="reason2" %%=v(@dubaiOption)=%%>
                    ...
                    <h4 class="pt-4 pb-3">How often do you visit Dubai Parks&trade; and Resorts?</h4>
                  ...
                  <h4 class="pt-4 pb-3">What do you like the most about Dubai Parks&trade; and Resorts?</h4>
...
IF RequestParameter("submittedInterests") == "true" then
 ...
 if not Empty(@primaryReasonPreferences) then
  ...
  /* Redirect(Concat("https://cloud.explore.dubaiparksandresorts.com/Bhavya_CPC_DRP_QA?sfid=", Base64Encode(@sfid), "#communications")) */
  set @communications = '#communications'
                                   ...
                                   if @methodType== 'Old' then
                                      Redirect(Concat("https://cloud.explore.dubaiparksandresorts.com/DPRQA_CPC?sfid=", Base64Encode(@sfid), "#communications"))
                                   ELSE
                                      Redirect(CONCAT(CloudPagesURL(2431),@communications))
                                   ENDIF
        ...
        <div class="tab-pane fade preferences-tab-content" id="communications" role="tabpanel" aria-labelledby="communications-tab">
          <div class="wrapper wrapper--w700">
            ...
            %%[
                               ...
                               if @methodType== 'Old' then
                                      Redirect(Concat("https://cloud.explore.dubaiparksandresorts.com/ThankYou_DPR_QA?sfid=", Base64Encode(@sfid), "#ThankYou"))
                               ELSE
                                      Redirect(CONCAT(CloudPagesURL(2442),@thankYouPage))
                              ENDIF
                                ENDIF
...
<div class="box-form mt-5" id="channel-preference">
    <span class="close-buttonCM" style="text-align: right; font-size: 30px; position: relative; left: 94%; top: 0; cursor: pointer; color:#ee5f02;">×</span>
    <div class="container">
        <div class="channelpreference-wrapper">
            ...
            <div class="thankYou-text">
              ...
              <p style="display: %%=IIF(@status == "Unsubscribed", "block", "none")=%%;font-size:16px; line-height:18px; color:#000000; font-weight: bold; padding-top:0rem;">Should you wish to receive our communications again, please subscribe through our <a href="https://www.dubaiparksandresorts.com/en" style=
"color:#212529;text-decoration: underline;" target="_blank">website</a>!</p>
            ...
            <div class="mt-5 pl-2" style="font-size: 16px;">
              <p>If you wish to unsubscribe from all Dubai Parks&trade; and Resorts communications please click on ‘Unsubscribe’.</p>
            </div>
      ...
      <input name="submittedUnsub" type="hidden" value="true">
             ...
             %%[
                                ...
                                IF RequestParameter("submittedUnsub")==true then
                                   ...
                                   /*Redirect(Concat("https://cloud.explore.dubaiparksandresorts.com/ThankYou_DPR?sfid=", Base64Encode(@sfid), "#ThankYou"))*/
                                   set @thankYouPage = '#ThankYou'
                                    if empty(@sfid) OR IsNull(@sfid) then
                                      Set @ampError = '00 - NO SUBSCRIBER KEY FOUND'
                                   ELSE
    ...
    <footer>
                <div class="container">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12 col-12 custom-height">
                      ...
                      <li class="pp">
                        <img alt="" data-assetid="" src="https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/0cd6669a-0b94-46ef-b812-aa4db9ab5160.png" style="width: 35px;" width="35">
                      </li>
                      <li class="pp">
                        <img alt="" data-assetid="" src="https://image.explore.dubaiparksandresorts.com/lib/fe3a117373640479751473/m/1/9510b497-9225-48b5-8da7-353c3e067265.png" style="width: 35px;" width="35">
                      </li>
      ...
      <!-- footer End -->                     
    <!-- Vendor JS-->
     <script src="https://cloud.explore.dubaiparksandresorts.com/bootstrap.bundle.min_dpr_qa"></script>
    <script src="https://cloud.explore.dubaiparksandresorts.com/select2.min.js_dpr_qa"></script>
    <script src="https://cloud.explore.dubaiparksandresorts.com/moment.min_dpr_qa"></script>
    <script src="https://cloud.explore.dubaiparksandresorts.com/daterangepicker.js_DPR_Prod"></script>

    <!-- Main JS-->
    <script src="https://cloud.explore.dubaiparksandresorts.com/custom_dpr_qa"></script>
    <script src="https://cloud.explore.dubaiparksandresorts.com/global_dpr_qa"></script>
    <script>
...
$(document).on("click", ".del", function() {
  ...
  console.log('deleted 2');
    ...
    $("#channel-submit").click(function(e) {
        ...
        $.ajax({
            url: 'https://cloud.explore.dubaiparksandresorts.com/DPR_QA_ChannelPreference', // Replace with your CloudPage URL
            method: 'POST',
            data: dataToSend,
            success: function(response) {
      ...
      $("#unsubscribeClick").click(function(e) {
        ...
        var subsKey = document.getElementById('crmId').value;
                ...
                $.ajax({
                    url: 'https://cloud.explore.dubaiparksandresorts.com/UnsubscribeFromBU', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
                        console.log('SFMC Code Resource called successfully.');
      ...
      $("#unsubscribeAllClick").click(function(e) {
        ...
        console.log('guestId: ',guestId);
                ...
                $.ajax({
                    url: 'https://cloud.explore.dubaiparksandresorts.com/UnsubscribeFromAllBU', // Replace with your CloudPage URL
                    method: 'POST',
                    data: dataToSend,
                    success: function(response) {
                        console.log('SFMC Code Resource called successfully.');
