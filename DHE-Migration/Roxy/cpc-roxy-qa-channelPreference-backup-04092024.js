...
ELSE
   Set @ampError = ''
ENDIF
Set @p= InsertData("PreferencesLog_Test","SubscriberKey",@subsKey,"EmailAddress",@emailContact,"Submission","CommunicationPage","AMPError",@ampError,"FirstName",@firstName,"LastName",@lastName)
