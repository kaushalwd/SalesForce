SELECT DISTINCT
    ...
    f.SubscriberKey,
    s.Status
FROM [Day16_Tier1_Tier2_Tier3_Tier4_Gmail_Email3_V2] f
...
SELECT DISTINCT
    ...
    f.SubscriberKey,
    s.Status
FROM [Day16_NonGmail_Email_3_V2] f
LEFT JOIN _Subscribers s
    ON f.Email = s.EmailAddress
WHERE s.Status != 'active'
...
SELECT DISTINCT
    ...
    f.SubscriberKey,
    s.Status
FROM [Day16_NonGmail_TeaserEmail_1] f
LEFT JOIN _Subscribers s
    ON f.Email = s.EmailAddress
WHERE s.Status != 'active'
...
SELECT
    ...
    COUNT(Email) AS OccurrenceCount
FROM 
    [Day16_Tier1_Tier2_Tier3_Tier4_Gmail_Email3_V2]
WHERE 
    Email IS NOT NULL
GROUP BY 
    Email
...
SELECT 
    current_day.Email,
    'Day15' AS OverlapSource
FROM 
    [Day16_Tier1_Tier2_Tier3_Tier4_Gmail_Email3_V2] AS current_day
INNER JOIN 
    [Day15_Gmail_TeaserEmail_1] AS past_day15
    ON current_day.Email = past_day15.Email          

UNION 

SELECT 
    current_day.Email,
    'Day15N' AS OverlapSource
FROM 
    [Day16_Tier1_Tier2_Tier3_Tier4_Gmail_Email3_V2] AS current_day
INNER JOIN 
    [Day15_Tier1_Tier2_Tier3_Tier4_Gmail_Email3_V2] AS past_day15n
    ON current_day.Email = past_day15n.Email    
...
SELECT 
    ...
    'Day15' AS OverlapSource
FROM 
    [Day16_NonGmail_Email_3_V2] AS current_day
INNER JOIN 
    [Day15_NonGmail_TeaserEmail_1] AS past_day15
    ON current_day.Email = past_day15.Email          
...
FROM 
    [Day16_NonGmail_TeaserEmail_1] AS current_day
INNER JOIN 
...
SELECT 
    current_day.Email,
    'Day14' AS OverlapSource
FROM 
    [Day16_NonGmail_TeaserEmail_1] AS current_day
INNER JOIN 
    [Day14_NonGmail_TeaserEmail_1] AS past_day14
    ON current_day.Email = past_day14.Email  
