SELECT DISTINCT
    ...
    f.SubscriberKey,
    s.Status
FROM [Day13_Tier1_Tier2_Tier3_NonGmail_Email2_V2] f
...
SELECT DISTINCT
    ...
    f.SubscriberKey,
    s.Status
FROM [Day13_Tier4_Tier5_Gmail_Email2_V2] f
LEFT JOIN _Subscribers s
    ON f.Email = s.EmailAddress
WHERE s.Status != 'active'
...
FROM 
    [Day13_Tier1_Tier2_Tier3_NonGmail_Email2_V2]
WHERE 
    Email IS NOT NULL
GROUP BY 
    Email
...
SELECT
    ...
    COUNT(Email) AS OccurrenceCount
FROM 
    [Day13_Tier4_Tier5_Gmail_Email2_V2]
WHERE 
    Email IS NOT NULL
GROUP BY 
    Email
...
FROM 
    [Day13_Tier4_Tier5_Gmail_Email2_V2] AS current_day
INNER JOIN 
...
SELECT 
    ...
    'Day12' AS OverlapSource
FROM 
    [Day13_Tier1_Tier2_Tier3_NonGmail_Email2_V2] AS current_day
INNER JOIN 
    [Day12_Tier3_Tier4_Tier5_NonGmail_Email2_V2] AS past_day12
    ON current_day.Email = past_day11.Emai2
