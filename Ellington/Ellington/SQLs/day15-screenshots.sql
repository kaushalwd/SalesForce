SELECT DISTINCT
    ...
    f.SubscriberKey,
    s.Status
FROM [Day15_NonGmail_TeaserEmail_1] f
...
SELECT DISTINCT
    ...
    f.SubscriberKey,
    s.Status
FROM [Day15_Gmail_TeaserEmail_1] f
LEFT JOIN _Subscribers s
    ON f.Email = s.EmailAddress
WHERE s.Status != 'active'
...
SELECT DISTINCT
    ...
    f.SubscriberKey,
    s.Status
FROM [Day15_Tier1_Tier2_Tier3_Tier4_Gmail_Email3_V2] f
LEFT JOIN _Subscribers s
    ON f.Email = s.EmailAddress
WHERE s.Status != 'active'
...
SELECT
    ...
    COUNT(Email) AS OccurrenceCount
FROM 
    [Day15_Tier1_Tier2_Tier3_Tier4_Gmail_Email3_V2]
WHERE 
    Email IS NOT NULL
GROUP BY 
    Email
...
FROM 
    [Day15_Gmail_TeaserEmail_1] AS current_day
INNER JOIN 
...
FROM 
    [Day15_Gmail_TeaserEmail_1] AS current_day
INNER JOIN 
    [Day14_Tier1_Tier2_Tier4_Tier5_Gmail_TeaserEmail_1] AS past_day14
...
SELECT 
    ...
    'Day12' AS OverlapSource
FROM 
    [Day15_NonGmail_TeaserEmail_1] AS current_day
INNER JOIN 
...
SELECT 
    ...
    'Day13' AS OverlapSource
FROM 
    [Day15_Tier1_Tier2_Tier3_Tier4_Gmail_Email3_V2] AS current_day
INNER JOIN 
    [Day13_Tier4_Tier5_Gmail_TeaserEmail_1] AS past_day13
    ON current_day.Email = past_day13.Email  
