%%[
   ...
   */
   ...
   IF @ProductMngrName == "" Then
     SET @ProductMngrName = ProperCase(Lookup("Test_Master_Users", "Name", "Customer_Store_Number__c", @CustomerStore, "IsActive", "True", "UserType2__c", "Product Support Manager"))
   ENDIF  
   
   IF Length(@ProductMngrPhone) == 0 Then
     SET @ProductMngrPhone = Lookup("Test_Master_Users", "MobilePhone", "Customer_Store_Number__c", @CustomerStore, "IsActive", "True", "UserType2__c", "Product Support Manager")
   ENDIF  
   ...
   IF @PartsMngrName == "" Then
     SET @PartsMngrName = ProperCase(Lookup("Test_Master_Users", "Name", "Customer_Store_Number__c", @CustomerStore, "IsActive", "True", "UserType2__c", "Parts Manager"))
   ENDIF
   
   IF @PartsMngrPhone == "" Then
     SET @PartsMngrPhone = ProperCase(Lookup("Test_Master_Users", "MobilePhone", "Customer_Store_Number__c", @CustomerStore, "IsActive", "True", "UserType2__c", "Parts Manager"))
   ENDIF
